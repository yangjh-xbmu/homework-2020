...
(() => {
    var t = {
        243: (t, e, i) => {
            ...
            !function(s, a, r) {
                var h, l, c = s.L, d = {};
                d.version = "0.7.7",
                    "object" == typeof t.exports ? t.exports = d : (n = "function" == typeof (o = d) ? o.call(e, i, e, t) : o) === r || (t.exports = n),
                    ...
                    d.Util = {
                        ...
                        invokeEach: function(t, e, i) {
                            var o, n;
                            if("object" == typeof t) {
                                for(o in n = Array.prototype.slice.call(arguments, 3),
                                    t)
                                    e.apply(i, [o, t[o]].concat(n));
                                return !0;
                            }
                            return !1;
                        },
                        ...
                        setOptions: function(t, e) {
                            return t.options = d.extend({}, t.options, e),
                                t.options;
                        },
                    ...
                    d.Class.extend = function(t) {
                        ...
                        var o = new i;
                        for(var n in o.constructor = e,
                            e.prototype = o,
                            this)
                            this.hasOwnProperty(n) && "prototype" !== n && (e[n] = this[n]);
                        t.statics && (d.extend(e, t.statics),
                            delete t.statics),
                            t.includes && (d.Util.extend.apply(null, [o].concat(t.includes)),
                                delete t.includes),
                            t.options && o.options && (t.options = d.extend({}, o.options, t.options)),
                            d.extend(o, t),
                            o._initHooks = [];
                        var s = this;
                ...
                d.Mixin = {},
                    d.Mixin.Events = {
                        addEventListener: function(t, e, i) {
                            if(d.Util.invokeEach(t, this.addEventListener, this, e, i))
                                return this;
                            var o, n, s, a, r, h, l, c = this[A] = this[A] || {}, p = i && i !== this && d.stamp(i);
                            for(o = 0,
                                n = (t = d.Util.splitWords(t)).length;o < n;o++)
                                s = {
                                    action: e,
                                    context: i || this
                                },
                        ...
                        removeEventListener: function(t, e, i) {
                            ...
                            if(d.Util.invokeEach(t, this.removeEventListener, this, e, i))
                                return this;
                            var o, n, s, a, r, h, l, c, p = this[A], _ = i && i !== this && d.stamp(i);
                            for(o = 0,
                                n = (t = d.Util.splitWords(t)).length;o < n;o++)
                                if(l = (h = (s = t[o]) + "_idx") + "_len",
                                    c = p[h],
                                    e) {
                                    if(a = _ && c ? c[_] : p[s]) {
                                        for(r = a.length - 1;r >= 0;r--)
                                            a[r].action !== e || i && a[r].context !== i || (a.splice(r, 1)[0].action = d.Util.falseFn);
                                        i && c && 0 === a.length && (delete c[_],
                                            p[l]--);
                                    }
                                } else
                                    delete p[s],
                        ...
                        fireEvent: function(t, e) {
                            ...
                            if(h[t])
                                for(o = 0,
                                    n = (i = h[t].slice()).length;o < n;o++)
                                    i[o].action.call(i[o].context, r);
                            for(a in s = h[t + "_idx"])
                                if(i = s[a].slice())
                                    for(o = 0,
                                        n = i.length;o < n;o++)
                        ...
                        addOneTimeEventListener: function(t, e, i) {
                            if(d.Util.invokeEach(t, this.addOneTimeEventListener, this, e, i))
                                return this;
                    ...
                    _ = (p = "ActiveXObject" in s) && !a.addEventListener,
                    u = navigator.userAgent.toLowerCase(),
                    m = -1 !== u.indexOf("webkit"),
                    g = -1 !== u.indexOf("chrome"),
                    f = -1 !== u.indexOf("phantom"),
                    v = -1 !== u.indexOf("android"),
                    y = -1 !== u.search("android [23]"),
                    w = -1 !== u.indexOf("gecko"),
                    b = typeof orientation != r + "",
                    L = !s.PointerEvent && s.MSPointerEvent,
                    x = s.PointerEvent && s.navigator.pointerEnabled || L,
                    M = "devicePixelRatio" in s && s.devicePixelRatio > 1 || "matchMedia" in s && s.matchMedia("(min-resolution:144dpi)") && s.matchMedia("(min-resolution:144dpi)").matches,
                    k = a.documentElement,
                    P = p && "transition" in k.style,
                    T = "WebKitCSSMatrix" in s && "m11" in new s.WebKitCSSMatrix && !y,
                    D = "MozPerspective" in k.style,
                    S = "OTransition" in k.style,
                    C = !s.L_DISABLE_3D && (P || T || D || S) && !f,
                    E = !s.L_NO_TOUCH && !f && (x || "ontouchstart" in s || s.DocumentTouch && a instanceof s.DocumentTouch),
                    d.Browser = {
                        ie: p,
                        ielt9: _,
                        webkit: m,
                    ...
                    d.Bounds.prototype = {
                        ...
                        contains: function(t) {
                            var e, i;
                            return (t = "number" == typeof t[0] || t instanceof d.Point ? d.point(t) : d.bounds(t)) instanceof d.Bounds ? (e = t.min,
                                i = t.max) : e = i = t,
                    ...
                    d.Transformation.prototype = {
                        ...
                        untransform: function(t, e) {
                            return e = e || 1,
                                new d.Point((t.x / e - this._b) / this._a, (t.y / e - this._d) / this._c);
                        }
                    },
                    d.DomUtil = {
                        get: function(t) {
                        ...
                        getViewportOffset: function(t) {
                            var e, i = 0, o = 0, n = t, s = a.body, r = a.documentElement;
                            do {
                                if(i += n.offsetTop || 0,
                                    o += n.offsetLeft || 0,
                                    i += parseInt(d.DomUtil.getStyle(n, "borderTopWidth"), 10) || 0,
                                    o += parseInt(d.DomUtil.getStyle(n, "borderLeftWidth"), 10) || 0,
                                    e = d.DomUtil.getStyle(n, "position"),
                                    n.offsetParent === s && "absolute" === e)
                                    break;
                                if("fixed" === e) {
                                ...
                                if("relative" === e && !n.offsetLeft) {
                                    ...
                                    "none" === h && "none" === l || (o += c.left + n.clientLeft),
                                        i += c.top + (s.scrollTop || r.scrollTop || 0);
                                    break;
                                }
                                n = n.offsetParent;
                            } while(n);
                        ...
                        documentIsLtr: function() {
                            return d.DomUtil._docIsLtrCached || (d.DomUtil._docIsLtrCached = !0,
                                d.DomUtil._docIsLtr = "ltr" === d.DomUtil.getStyle(a.body, "direction")),
                                d.DomUtil._docIsLtr;
                        },
                        ...
                        addClass: function(t, e) {
                            if(t.classList !== r)
                                for(var i = d.Util.splitWords(e), o = 0, n = i.length;o < n;o++)
                                    t.classList.add(i[o]);
                        ...
                        setPosition: function(t, e, i) {
                            t._leaflet_pos = e,
                                !i && d.Browser.any3d ? t.style[d.DomUtil.TRANSFORM] = d.DomUtil.getTranslateString(e) : (t.style.left = e.x + "px",
                                    t.style.top = e.y + "px");
                        },
                    ...
                    function() {
                        if("onselectstart" in a)
                            ...
                            d.extend(d.DomUtil, {
                                ...
                                enableTextSelection: function() {
                                    t && (a.documentElement.style[t] = this._userSelect,
                    ...
                    d.LatLng.prototype = {
                        equals: function(t) {
                            return !!t && (t = d.latLng(t),
                                Math.max(Math.abs(this.lat - t.lat), Math.abs(this.lng - t.lng)) <= d.LatLng.MAX_MARGIN);
                        },
                        toString: function(t) {
                        ...
                        wrap: function(t, e) {
                            var i = this.lng;
                            return i = (i + (e = e || 180)) % (e - (t = t || -180)) + (i < t || i === e ? e : t),
                    ...
                    d.LatLngBounds.prototype = {
                        extend: function(t) {
                            if(!t)
                                return this;
                            var e = d.latLng(t);
                            return (t = null !== e ? e : d.latLngBounds(t)) instanceof d.LatLng ? this._southWest || this._northEast ? (this._southWest.lat = Math.min(t.lat, this._southWest.lat),
                                this._southWest.lng = Math.min(t.lng, this._southWest.lng),
                                this._northEast.lat = Math.max(t.lat, this._northEast.lat),
                                this._northEast.lng = Math.max(t.lng, this._northEast.lng)) : (this._southWest = new d.LatLng(t.lat, t.lng),
                                    this._northEast = new d.LatLng(t.lat, t.lng)) : t instanceof d.LatLngBounds && (this.extend(t._southWest),
                        ...
                        contains: function(t) {
                            ...
                            return t instanceof d.LatLngBounds ? (e = t.getSouthWest(),
                    ...
                    d.Map = d.Class.extend({
                        ...
                        initialize: function(t, e) {
                            e = d.setOptions(this, e),
                                this._initContainer(t),
                                this._initLayout(),
                                this._onResize = d.bind(this._onResize, this),
                                this._initEvents(),
                                e.maxBounds && this.setMaxBounds(e.maxBounds),
                                e.center && e.zoom !== r && this.setView(d.latLng(e.center), e.zoom, {
                                    reset: !0
                                }),
                                this._handlers = [],
                                this._layers = {},
                        ...
                        setView: function(t, e) {
                            return e = e === r ? this.getZoom() : e,
                                this._resetView(d.latLng(t), this._limitZoom(e)),
                                this;
                        },
                        ...
                        fitBounds: function(t, e) {
                            e = e || {},
                                t = t.getBounds ? t.getBounds() : d.latLngBounds(t);
                        ...
                        panBy: function(t) {
                            return this.fire("movestart"),
                                this._rawPanBy(d.point(t)),
                                this.fire("move"),
                                this.fire("moveend");
                        },
                        setMaxBounds: function(t) {
                            return t = d.latLngBounds(t),
                        ...
                        addLayer: function(t) {
                            ...
                            return this._layers[e] || (this._layers[e] = t,
                                ...
                                this.options.zoomAnimation && d.TileLayer && t instanceof d.TileLayer && (this._tileLayersNum++,
                        ...
                        invalidateSize: function(t) {
                            ...
                            return s.x || s.y ? (t.animate && t.pan ? this.panBy(s) : (t.pan && this._rawPanBy(s),
                                ...
                                t.debounceMoveend ? (clearTimeout(this._sizeTimer),
                                    this._sizeTimer = setTimeout(d.bind(this.fire, this, "moveend"), 200)) : this.fire("moveend")),
                                this.fire("resize", {
                                    oldSize: e,
                                    newSize: i
                                })) : this;
                        ...
                        getBoundsZoom: function(t, e, i) {
                            t = d.latLngBounds(t);
                            var o, n = this.getMinZoom() - (e ? 1 : 0), s = this.getMaxZoom(), a = this.getSize(), r = t.getNorthWest(), h = t.getSouthEast(), l = !0;
                            i = d.point(i || [0, 0]);
                            do {
                                n++,
                                    o = this.project(h, n).subtract(this.project(r, n)).add(i),
                                    l = e ? o.x < a.x || o.y < a.y : a.contains(o);
                            } while(l && n <= s);
                        ...
                        project: function(t, e) {
                            return e = e === r ? this._zoom : e,
                                this.options.crs.latLngToPoint(d.latLng(t), e);
                        },
                        unproject: function(t, e) {
                            return e = e === r ? this._zoom : e,
                                this.options.crs.pointToLatLng(d.point(t), e);
                        },
                        ...
                        _initPanes: function() {
                            ...
                            this.options.markerZoomAnimation || (d.DomUtil.addClass(t.markerPane, e),
                                d.DomUtil.addClass(t.shadowPane, e),
                                d.DomUtil.addClass(t.popupPane, e));
                        },
                        ...
                        _addLayers: function(t) {
                            for(var e = 0, i = (t = t ? d.Util.isArray(t) ? t : [t] : []).length;e < i;e++)
                                this.addLayer(t[e]);
                        },
                        _resetView: function(t, e, i, o) {
                            var n = this._zoom !== e;
                            o || (this.fire("movestart"),
                                n && this.fire("zoomstart")),
                                this._zoom = e,
                                this._initialCenter = t,
                                this._initialTopLeftPoint = this._getNewTopLeftPoint(t),
                                i ? this._initialTopLeftPoint._add(this._getMapPanePos()) : d.DomUtil.setPosition(this._mapPane, new d.Point(0, 0)),
                        ...
                        _updateZoomLevels: function() {
                            ...
                            for(t in this._zoomBoundLayers) {
                                ...
                                isNaN(n.options.minZoom) || (e = Math.min(e, n.options.minZoom)),
                                    isNaN(n.options.maxZoom) || (i = Math.max(i, n.options.maxZoom));
                            }
                            t === r ? this._layersMaxZoom = this._layersMinZoom = r : (this._layersMaxZoom = i,
                        ...
                        _initEvents: function(t) {
                            if(d.DomEvent) {
                                t = t || "on",
                                    d.DomEvent[t](this._container, "click", this._onMouseClick, this);
                                var e, i, o = ["dblclick", "mousedown", "mouseup", "mouseenter", "mouseleave", "mousemove", "contextmenu"];
                                for(e = 0,
                                    i = o.length;e < i;e++)
                                    d.DomEvent[t](this._container, o[e], this._fireMouseEvent, this);
                        ...
                        _onMouseClick: function(t) {
                            !this._loaded || !t._simulated && (this.dragging && this.dragging.moved() || this.boxZoom && this.boxZoom.moved()) || d.DomEvent._skipped(t) || (this.fire("preclick"),
                    ...
                    d.Projection.Mercator = {
                        ...
                        project: function(t) {
                            ...
                            return r = -n * Math.log(p),
                                new d.Point(a, r);
                        },
                        unproject: function(t) {
                            for(var e, i = d.LatLng.RAD_TO_DEG, o = this.R_MAJOR, n = this.R_MINOR, s = t.x * i / o, a = n / o, r = Math.sqrt(1 - a * a), h = Math.exp(-t.y / o), l = Math.PI / 2 - 2 * Math.atan(h), c = 15, p = .1;Math.abs(p) > 1e-7 && --c > 0;)
                                e = r * Math.sin(l),
                                    l += p = Math.PI / 2 - 2 * Math.atan(h * Math.pow((1 - e) / (1 + e), .5 * r)) - l;
                    ...
                    d.CRS.EPSG3395 = d.extend({}, d.CRS, {
                        ...
                        transformation: (O = d.Projection.Mercator.R_MAJOR,
                            z = .5 / (Math.PI * O),
                            new d.Transformation(z, .5, -z, .5))
                    }),
                    d.TileLayer = d.Class.extend({
                        ...
                        initialize: function(t, e) {
                            (e = d.setOptions(this, e)).detectRetina && d.Browser.retina && e.maxZoom > 0 && (e.tileSize = Math.floor(e.tileSize / 2),
                                e.zoomOffset++,
                                e.minZoom > 0 && e.minZoom--,
                                this.options.maxZoom--),
                                e.bounds && (e.bounds = d.latLngBounds(e.bounds)),
                                this._url = t;
                        ...
                        onAdd: function(t) {
                            this._map = t,
                                ...
                                this.options.updateWhenIdle || (this._limitedUpdate = d.Util.limitExecByInterval(this._update, 150, this),
                        ...
                        _setAutoZIndex: function(t, e) {
                            var i, o, n, s = t.children, a = -e(1 / 0, -1 / 0);
                            for(o = 0,
                                n = s.length;o < n;o++)
                                s[o] !== this._container && (i = parseInt(s[o].style.zIndex, 10),
                                    isNaN(i) || (a = e(a, i)));
                        ...
                        _updateOpacity: function() {
                            ...
                            if(d.Browser.ielt9)
                                for(t in e)
                                    d.DomUtil.setOpacity(e[t], this.options.opacity);
                            else
                        ...
                        _initContainer: function() {
                            var t = this._map._panes.tilePane;
                            if(!this._container) {
                                if(this._container = d.DomUtil.create("div", "leaflet-layer"),
                                    this._updateZIndex(),
                                    this._animated) {
                                    var e = "leaflet-tile-container";
                                    this._bgBuffer = d.DomUtil.create("div", e, this._container),
                                        this._tileContainer = d.DomUtil.create("div", e, this._container);
                                } else
                        ...
                        _getTileSize: function() {
                            ...
                            return i && e > i && (o = Math.round(t.getZoomScale(e) / t.getZoomScale(i) * o)),
                                o;
                        },
                        _update: function() {
                            if(this._map) {
                        ...
                        _addTilesFromCenterOut: function(t) {
                            var e, i, o, n = [], s = t.getCenter();
                            for(e = t.min.y;e <= t.max.y;e++)
                                for(i = t.min.x;i <= t.max.x;i++)
                                    o = new d.Point(i, e),
                                        this._tileShouldBeLoaded(o) && n.push(o);
                            var r = n.length;
                            if(0 !== r) {
                                n.sort((function(t, e) {
                        ...
                        _removeOtherTiles: function(t) {
                            ...
                            for(n in this._tiles)
                                e = n.split(":"),
                                    i = parseInt(e[0], 10),
                                    o = parseInt(e[1], 10),
                                    (i < t.min.x || i > t.max.x || o < t.min.y || o > t.max.y) && this._removeTile(n);
                        },
                        _removeTile: function(t) {
                            ...
                            this.fire("tileunload", {
                                ...
                                this.options.reuseTiles ? (d.DomUtil.removeClass(e, "leaflet-tile-loaded"),
                                    this._unusedTiles.push(e)) : e.parentNode === this._tileContainer && this._tileContainer.removeChild(e),
                                d.Browser.android || (e.onload = null,
                                    e.src = d.Util.emptyImageUrl),
                                delete this._tiles[t];
                        },
                        _addTile: function(t, e) {
                            var i = this._getTilePos(t)
                                , o = this._getTile();
                            d.DomUtil.setPosition(o, i, d.Browser.chrome),
                                this._tiles[t.x + ":" + t.y] = o,
                                this._loadTile(o, t),
                                o.parentNode !== this._tileContainer && e.appendChild(o);
                        },
                    ...
                    d.TileLayer.WMS = d.TileLayer.extend({
                        ...
                        initialize: function(t, e) {
                            ...
                            for(var n in e.detectRetina && d.Browser.retina ? i.width = i.height = 2 * o : i.width = i.height = o,
                                e)
                                this.options.hasOwnProperty(n) || "crs" === n || (i[n] = e[n]);
                            this.wmsParams = i,
                                d.setOptions(this, e);
                        },
                        onAdd: function(t) {
                            ...
                            this.wmsParams[e] = this._crs.code,
                                d.TileLayer.prototype.onAdd.call(this, t);
                        },
                        getTileUrl: function(t) {
                            var e = this._map
                        ...
                        setParams: function(t, e) {
                            return d.extend(this.wmsParams, t),
                                e || this.redraw(),
                                this;
                        }
                    }),
                    ...
                    d.ImageOverlay = d.Class.extend({
                        ...
                        onAdd: function(t) {
                            this._map = t,
                                ...
                                t.options.zoomAnimation && d.Browser.any3d && t.on("zoomanim", this._animateZoom, this),
                                this._reset();
                        },
                        onRemove: function(t) {
                    ...
                    d.Icon = d.Class.extend({
                        ...
                        _createIcon: function(t, e) {
                            ...
                            return i = e && "IMG" === e.tagName ? this._createImg(o, e) : this._createImg(o),
                                this._setIconStyles(i, t),
                                i;
                        },
                        _setIconStyles: function(t, e) {
                            var i, o = this.options, n = d.point(o[e + "Size"]);
                            !(i = "shadow" === e ? d.point(o.shadowAnchor || o.iconAnchor) : d.point(o.iconAnchor)) && n && (i = n.divideBy(2, !0)),
                        ...
                        _createImg: function(t, e) {
                            return (e = e || a.createElement("img")).src = t,
                                e;
                        },
                    ...
                    d.Icon.Default.imagePath = function() {
                        var t, e, i, o, n = a.getElementsByTagName("script"), s = /[\/^]leaflet[\-\._]?([\w\-\._]*)\.js\??/;
                        for(t = 0,
                            e = n.length;t < e;t++)
                            if((i = n[t].src).match(s))
                                return ((o = i.split(s)[0]) ? o + "/" : "") + "images";
                    }(),
                    d.Marker = d.Class.extend({
                        ...
                        setLatLng: function(t) {
                            return this._latlng = d.latLng(t),
                                this.update(),
                                this.fire("move", {
                                    latlng: this._latlng
                                });
                        ...
                        _initIcon: function() {
                            ...
                            o !== this._icon && (this._icon && this._removeIcon(),
                                ...
                                t.alt && (o.alt = t.alt)),
                                d.DomUtil.addClass(o, i),
                                t.keyboard && (o.tabIndex = "0"),
                                this._icon = o,
                                this._initInteraction(),
                                t.riseOnHover && d.DomEvent.on(o, "mouseover", this._bringToFront, this).on(o, "mouseout", this._resetZIndex, this);
                            var s = t.icon.createShadow(this._shadow)
                                , a = !1;
                            s !== this._shadow && (this._removeShadow(),
                                a = !0),
                                s && d.DomUtil.addClass(s, i),
                                this._shadow = s,
                                t.opacity < 1 && this._updateOpacity();
                            var r = this._map._panes;
                            n && r.markerPane.appendChild(this._icon),
                        ...
                        _setPos: function(t) {
                            d.DomUtil.setPosition(this._icon, t),
                                this._shadow && d.DomUtil.setPosition(this._shadow, t),
                        ...
                        _initInteraction: function() {
                            if(this.options.clickable) {
                                ...
                                d.DomUtil.addClass(t, "leaflet-clickable"),
                                    d.DomEvent.on(t, "click", this._onMouseClick, this),
                                    d.DomEvent.on(t, "keypress", this._onKeyPress, this);
                                for(var i = 0;i < e.length;i++)
                                    d.DomEvent.on(t, e[i], this._fireMouseEvent, this);
                        ...
                        _onMouseClick: function(t) {
                            ...
                            (this.hasEventListeners(t.type) || e) && d.DomEvent.stopPropagation(t),
                        ...
                        _fireMouseEvent: function(t) {
                            this.fire(t.type, {
                                ...
                                "contextmenu" === t.type && this.hasEventListeners(t.type) && d.DomEvent.preventDefault(t),
                                "mousedown" !== t.type ? d.DomEvent.stopPropagation(t) : d.DomEvent.preventDefault(t);
                        },
                        setOpacity: function(t) {
                            return this.options.opacity = t,
                                this._map && this._updateOpacity(),
                    ...
                    d.Popup = d.Class.extend({
                        ...
                        onAdd: function(t) {
                            ...
                            e && d.DomUtil.setOpacity(this._container, 0),
                                t._panes.popupPane.appendChild(this._container),
                                t.on(this._getEvents(), this),
                                this.update(),
                                e && d.DomUtil.setOpacity(this._container, 1),
                                this.fire("open"),
                                t.fire("popupopen", {
                                    popup: this
                                }),
                        ...
                        onRemove: function(t) {
                            t._panes.popupPane.removeChild(this._container),
                                ...
                                t.options.fadeAnimation && d.DomUtil.setOpacity(this._container, 0),
                                this._map = null,
                                this.fire("close"),
                                t.fire("popupclose", {
                                    popup: this
                        ...
                        _initLayout: function() {
                            var t, e = "leaflet-popup", i = e + " " + this.options.className + " leaflet-zoom-" + (this._animated ? "animated" : "hide"), o = this._container = d.DomUtil.create("div", i);
                            this.options.closeButton && ((t = this._closeButton = d.DomUtil.create("a", e + "-close-button", o)).href = "#close",
                                t.innerHTML = "&#215;",
                                d.DomEvent.disableClickPropagation(t),
                                d.DomEvent.on(t, "click", this._onCloseButtonClick, this));
                            var n = this._wrapper = d.DomUtil.create("div", e + "-content-wrapper", o);
                            d.DomEvent.disableClickPropagation(n),
                                this._contentNode = d.DomUtil.create("div", e + "-content", n),
                                d.DomEvent.disableScrollPropagation(this._contentNode),
                                d.DomEvent.on(n, "contextmenu", d.DomEvent.stopPropagation),
                                this._tipContainer = d.DomUtil.create("div", e + "-tip-container", o),
                                this._tip = d.DomUtil.create("div", e + "-tip", this._tipContainer);
                        },
                        ...
                        _updateLayout: function() {
                            ...
                            n && o > n ? (e.height = n + "px",
                                d.DomUtil.addClass(t, s)) : d.DomUtil.removeClass(t, s),
                        ...
                        _updatePosition: function() {
                            if(this._map) {
                                ...
                                e && d.DomUtil.setPosition(this._container, t),
                        ...
                        _adjustPan: function() {
                            if(this.options.autoPan) {
                                ...
                                var n = t.layerPointToContainerPoint(o)
                                    ...
                                    , l = 0
                                    , c = 0;
                                n.x + i + r.x > h.x && (l = n.x + i - h.x + r.x),
                                    n.x - l - a.x < 0 && (l = n.x - a.x),
                                    n.y + e + r.y > h.y && (c = n.y + e - h.y + r.y),
                                    n.y - c - a.y < 0 && (c = n.y - a.y),
                    ...
                    d.Marker.include({
                        ...
                        bindPopup: function(t, e) {
                            ...
                            return i = i.add(d.Popup.prototype.options.offset),
                                ...
                                t instanceof d.Popup ? (d.setOptions(t, e),
                                    this._popup = t,
                                    t._source = this) : this._popup = new d.Popup(e, this).setContent(t),
                                this;
                        },
                    ...
                    d.FeatureGroup = d.LayerGroup.extend({
                        ...
                        addLayer: function(t) {
                            return this.hasLayer(t) ? this : ("on" in t && t.on(d.FeatureGroup.EVENTS, this._propagateEvent, this),
                                d.LayerGroup.prototype.addLayer.call(this, t),
                        ...
                        removeLayer: function(t) {
                            return this.hasLayer(t) ? (t in this._layers && (t = this._layers[t]),
                                "off" in t && t.off(d.FeatureGroup.EVENTS, this._propagateEvent, this),
                                d.LayerGroup.prototype.removeLayer.call(this, t),
                    ...
                    d.Path = d.Class.extend({
                        includes: [d.Mixin.Events],
                        statics: {
                            CLIP_PADDING: (B = ((d.Browser.mobile ? 1280 : 2e3) / Math.max(s.outerWidth, s.outerHeight) - 1) / 2,
                                Math.max(0, Math.min(.5, B)))
                        },
                        options: {
                            stroke: !0,
                            color: "#0033ff",
                    ...
                    d.Browser.svg = !(!a.createElementNS || !a.createElementNS(d.Path.SVG_NS, "svg").createSVGRect),
                    d.Path = d.Path.extend({
                        ...
                        _initPath: function() {
                            this._container = this._createElement("g"),
                                ...
                                this.options.className && d.DomUtil.addClass(this._path, this.options.className),
                        ...
                        _initEvents: function() {
                            if(this.options.clickable) {
                                ...
                                for(var t = ["dblclick", "mousedown", "mouseover", "mouseout", "mousemove", "contextmenu"], e = 0;e < t.length;e++)
                                    d.DomEvent.on(this._container, t[e], this._fireMouseEvent, this);
                            }
                        },
                        _onMouseClick: function(t) {
                        ...
                        _fireMouseEvent: function(t) {
                            if(this._map && this.hasEventListeners(t.type)) {
                                ...
                                this.fire(t.type, {
                                    ...
                                    "contextmenu" === t.type && d.DomEvent.preventDefault(t),
                                    "mousemove" !== t.type && d.DomEvent.stopPropagation(t);
                            }
                        }
                    }),
                    d.Map.include({
                        ...
                        _animatePathZoom: function(t) {
                            ...
                            this._pathRoot.style[d.DomUtil.TRANSFORM] = d.DomUtil.getTranslateString(i) + " scale(" + e + ") ",
                                this._pathZooming = !0;
                        },
                        ...
                        _updateSvgViewport: function() {
                            if(!this._pathZooming) {
                                ...
                                d.Browser.mobileWebkit && a.removeChild(s),
                                    d.DomUtil.setPosition(s, e),
                                    s.setAttribute("width", o),
                                    s.setAttribute("height", n),
                                    s.setAttribute("viewBox", [e.x, e.y, o, n].join(" ")),
                                    d.Browser.mobileWebkit && a.appendChild(s);
                            }
                        }
                    }),
                    d.Path.include({
                        bindPopup: function(t, e) {
                            return t instanceof d.Popup ? this._popup = t : (this._popup && !e || (this._popup = new d.Popup(e, this)),
                    ...
                    d.Path = d.Browser.svg || !d.Browser.vml ? d.Path : d.Path.extend({
                        ...
                        _initPath: function() {
                            ...
                            d.DomUtil.addClass(t, "leaflet-vml-shape" + (this.options.className ? " " + this.options.className : "")),
                                this.options.clickable && d.DomUtil.addClass(t, "leaflet-clickable"),
                                t.coordsize = "1 1",
                                this._path = this._createElement("path"),
                        ...
                        _updateStyle: function() {
                            ...
                            o.stroked = i.stroke,
                                ...
                                i.stroke ? (t || ((t = this._stroke = this._createElement("stroke")).endcap = "round",
                                    ...
                                    t.color = i.color,
                                    t.opacity = i.opacity,
                                    i.dashArray ? t.dashStyle = d.Util.isArray(i.dashArray) ? i.dashArray.join(" ") : i.dashArray.replace(/( *, *)/g, " ") : t.dashStyle = "",
                                    i.lineCap && (t.endcap = i.lineCap.replace("butt", "flat")),
                                    i.lineJoin && (t.joinstyle = i.lineJoin)) : t && (o.removeChild(t),
                                        this._stroke = null),
                                i.fill ? (e || (e = this._fill = this._createElement("fill"),
                                    o.appendChild(e)),
                                    e.color = i.fillColor || i.color,
                                    e.opacity = i.fillOpacity) : e && (o.removeChild(e),
                                        this._fill = null);
                        },
                        _updatePath: function() {
                    ...
                    d.Path = d.Path.SVG && !s.L_PREFER_CANVAS || !d.Browser.canvas ? d.Path : d.Path.extend({
                        statics: {
                            CANVAS: !0,
                            SVG: !1
                        },
                    ...
                    d.Map.include(d.Path.SVG && !s.L_PREFER_CANVAS || !d.Browser.canvas ? {} : {
                        _initPathRoot: function() {
                            ...
                            e || ((e = this._pathRoot = a.createElement("canvas")).style.position = "absolute",
                        ...
                        _updateCanvasViewport: function() {
                            if(!this._pathZooming) {
                                ...
                                var t = this._pathViewport
                                    ...
                                    , i = t.max.subtract(e)
                                    , o = this._pathRoot;
                                d.DomUtil.setPosition(o, e),
                                    o.width = i.x,
                                    o.height = i.y,
                                    o.getContext("2d").translate(-e.x, -e.y);
                            }
                        }
                    }),
                    d.LineUtil = {
                        ...
                        _simplifyDP: function(t, e) {
                            var i = t.length
                                , o = new (typeof Uint8Array != r + "" ? Uint8Array : Array)(i);
                            o[0] = o[i - 1] = 1,
                                this._simplifyDPStep(t, o, e, 0, i - 1);
                            var n, s = [];
                            for(n = 0;n < i;n++)
                                o[n] && s.push(t[n]);
                            return s;
                        ...
                        _simplifyDPStep: function(t, e, i, o, n) {
                            var s, a, r, h = 0;
                            for(a = o + 1;a <= n - 1;a++)
                                (r = this._sqClosestPointOnSegment(t[a], t[o], t[n], !0)) > h && (s = a,
                                    h = r);
                            h > i && (e[s] = 1,
                                this._simplifyDPStep(t, e, i, o, s),
                                this._simplifyDPStep(t, e, i, s, n));
                        },
                        _reducePoints: function(t, e) {
                            for(var i = [t[0]], o = 1, n = 0, s = t.length;o < s;o++)
                                this._sqDist(t[o], t[n]) > e && (i.push(t[o]),
                                    n = o);
                            return n < s - 1 && i.push(t[s - 1]),
                                i;
                        },
                        clipSegment: function(t, e, i, o) {
                            var n, s, a, r = o ? this._lastCode : this._getBitCode(t, i), h = this._getBitCode(e, i);
                            for(this._lastCode = h;;) {
                                ...
                                if(r & h)
                                    return !1;
                                n = r || h,
                                    s = this._getEdgeIntersection(t, e, n, i),
                        ...
                        _sqClosestPointOnSegment: function(t, e, i, o) {
                            ...
                            return l > 0 && ((n = ((t.x - s) * r + (t.y - a) * h) / l) > 1 ? (s = i.x,
                                ...
                                r = t.x - s,
                                h = t.y - a,
                                o ? r * r + h * h : new d.Point(s, a);
                        }
                    },
                    d.Polyline = d.Path.extend({
                        initialize: function(t, e) {
                            d.Path.prototype.initialize.call(this, e),
                        ...
                        addLatLng: function(t) {
                            return this._latlngs.push(d.latLng(t)),
                                this.redraw();
                        },
                        ...
                        closestLayerPoint: function(t) {
                            for(var e, i, o = 1 / 0, n = this._parts, s = null, a = 0, r = n.length;a < r;a++)
                                for(var h = n[a], l = 1, c = h.length;l < c;l++) {
                                    ...
                                    p < o && (o = p,
                                        s = d.LineUtil._sqClosestPointOnSegment(t, e, i));
                                }
                            return s && (s.distance = Math.sqrt(o)),
                                s;
                        },
                        getBounds: function() {
                        ...
                        _convertLatLngs: function(t, e) {
                            ...
                            for(i = 0,
                                o = t.length;i < o;i++) {
                                if(d.Util.isArray(t[i]) && "number" != typeof t[i][0])
                                    return;
                                n[i] = d.latLng(t[i]);
                            }
                            return n;
                        ...
                        _getPathPartStr: function(t) {
                            for(var e, i = d.Path.VML, o = 0, n = t.length, s = "";o < n;o++)
                                e = t[o],
                                    i && e._round(),
                                    s += (o ? "L" : "M") + e.x + " " + e.y;
                            return s;
                        ...
                        _clipPoints: function() {
                            var t, e, i, o = this._originalPoints, n = o.length;
                            if(this.options.noClip)
                                ...
                                for(t = 0,
                                    e = 0;t < n - 1;t++)
                                    (i = r.clipSegment(o[t], o[t + 1], a, t)) && (s[e] = s[e] || [],
                                        s[e].push(i[0]),
                                        i[1] === o[t + 1] && t !== n - 2 || (s[e].push(i[1]),
                                            e++));
                            }
                        },
                        _simplifyPoints: function() {
                            for(var t = this._parts, e = d.LineUtil, i = 0, o = t.length;i < o;i++)
                    ...
                    ,
                    d.PolyUtil = {},
                    d.PolyUtil.clipPolygon = function(t, e) {
                        var i, o, n, s, a, r, h, l, c, p = [1, 4, 2, 8], _ = d.LineUtil;
                        for(o = 0,
                            h = t.length;o < h;o++)
                            t[o]._code = _._getBitCode(t[o], e);
                        for(s = 0;s < 4;s++) {
                            for(l = p[s],
                                i = [],
                                o = 0,
                                n = (h = t.length) - 1;o < h;n = o++)
                                a = t[o],
                                    r = t[n],
                                    a._code & l ? r._code & l || ((c = _._getEdgeIntersection(r, a, l, e))._code = _._getBitCode(c, e),
                                        i.push(c)) : (r._code & l && ((c = _._getEdgeIntersection(r, a, l, e))._code = _._getBitCode(c, e),
                                            i.push(c)),
                                            i.push(a));
                            t = i;
                        }
                    ...
                    d.Polygon = d.Polyline.extend({
                        ...
                        initialize: function(t, e) {
                            d.Polyline.prototype.initialize.call(this, t, e),
                        ...
                        _initWithHoles: function(t) {
                            ...
                            if(t && d.Util.isArray(t[0]) && "number" != typeof t[0][0])
                                for(this._latlngs = this._convertLatLngs(t[0]),
                                    ...
                                    (o = this._holes[e] = this._convertLatLngs(this._holes[e]))[0].equals(o[o.length - 1]) && o.pop();
                        ...
                        projectLatlngs: function() {
                            ...
                            if(d.Polyline.prototype.projectLatlngs.call(this),
                                ...
                                this._holes)
                                for(t = 0,
                                    i = this._holes.length;t < i;t++)
                                    for(this._holePoints[t] = [],
                                        e = 0,
                                        o = this._holes[t].length;e < o;e++)
                                        this._holePoints[t][e] = this._map.latLngToLayerPoint(this._holes[t][e]);
                        },
                        setLatLngs: function(t) {
                            return t && d.Util.isArray(t[0]) && "number" != typeof t[0][0] ? (this._initWithHoles(t),
                                this.redraw()) : d.Polyline.prototype.setLatLngs.call(this, t);
                        },
                        _clipPoints: function() {
                    ...
                    function() {
                        ...
                        d.MultiPolyline = t(d.Polyline),
                            d.MultiPolygon = t(d.Polygon),
                            d.multiPolyline = function(t, e) {
                    ...
                    d.Circle = d.Path.extend({
                        ...
                        getPathString: function() {
                            var t = this._point
                                , e = this._radius;
                            return this._checkIfEmpty() ? "" : d.Browser.svg ? "M" + t.x + "," + (t.y - e) + "A" + e + "," + e + ",0,1,1," + (t.x - .1) + "," + (t.y - e) + " z" : (t._round(),
                                e = Math.round(e),
                    ...
                    d.CircleMarker = d.Circle.extend({
                        ...
                        initialize: function(t, e) {
                            d.Circle.prototype.initialize.call(this, t, null, e),
                        ...
                        setLatLng: function(t) {
                            return d.Circle.prototype.setLatLng.call(this, t),
                    ...
                    d.Polyline.include(d.Path.CANVAS ? {
                        _containsPoint: function(t, e) {
                            ...
                            for(d.Browser.touch && (h += 10),
                                i = 0,
                                s = this._parts.length;i < s;i++)
                                for(o = 0,
                                    n = (a = (r = this._parts[i]).length) - 1;o < a;n = o++)
                                    if((e || 0 !== o) && d.LineUtil.pointToSegmentDistance(t, r[n], r[o]) <= h)
                                        return !0;
                            return !1;
                        }
                    } : {}),
                    d.Polygon.include(d.Path.CANVAS ? {
                        _containsPoint: function(t) {
                            ...
                            if(d.Polyline.prototype._containsPoint.call(this, t, !0))
                                return !0;
                            for(n = 0,
                    ...
                    d.GeoJSON = d.FeatureGroup.extend({
                        ...
                        addData: function(t) {
                            ...
                            if(n) {
                                for(e = 0,
                                    i = n.length;e < i;e++)
                                    ((o = n[e]).geometries || o.geometry || o.features || o.coordinates) && this.addData(n[e]);
                                return this;
                            }
                            var s = this.options;
                            if(!s.filter || s.filter(t)) {
                                var a = d.GeoJSON.geometryToLayer(t, s.pointToLayer, s.coordsToLatLng, s);
                                return a.feature = d.GeoJSON.asFeature(t),
                        ...
                        resetStyle: function(t) {
                            ...
                            e && (d.Util.extend(t.options, t.defaultOptions),
                    ...
                    d.extend(d.GeoJSON, {
                        geometryToLayer: function(t, e, i, o) {
                            var n, s, a, r, h = "Feature" === t.type ? t.geometry : t, l = h.coordinates, c = [];
                            switch(i = i || this.coordsToLatLng,
                            h.type) {
                                case "Point":
                                    return n = i(l),
                                        e ? e(t, n) : new d.Marker(n);
                                case "MultiPoint":
                                    for(a = 0,
                                        r = l.length;a < r;a++)
                                        n = i(l[a]),
                                            c.push(e ? e(t, n) : new d.Marker(n));
                                ...
                                case "MultiLineString":
                                    return s = this.coordsToLatLngs(l, 1, i),
                                        new d.MultiPolyline(s, o);
                                case "MultiPolygon":
                                    return s = this.coordsToLatLngs(l, 2, i),
                                        new d.MultiPolygon(s, o);
                        ...
                        coordsToLatLngs: function(t, e, i) {
                            ...
                            for(n = 0,
                                s = t.length;n < s;n++)
                                o = e ? this.coordsToLatLngs(t[n], e - 1, i) : (i || this.coordsToLatLng)(t[n]),
                                    a.push(o);
                            return a;
                        },
                        latLngToCoords: function(t) {
                            var e = [t.lng, t.lat];
                            return t.alt !== r && e.push(t.alt),
                                e;
                        },
                        latLngsToCoords: function(t) {
                            for(var e = [], i = 0, o = t.length;i < o;i++)
                                e.push(d.GeoJSON.latLngToCoords(t[i]));
                            return e;
                        },
                ...
                d.Marker.include(I),
                        ...
                        toGeoJSON: function() {
                            ...
                            if(o[0].push(o[0][0]),
                                ...
                                for(t = 0,
                                    ...
                                    (i = d.GeoJSON.latLngsToCoords(this._holes[t])).push(i[0]),
                                        o.push(i);
                            return d.GeoJSON.getFeature(this, {
                                type: "Polygon",
                                coordinates: o
                    ...
                    d.DomEvent = {
                        addListener: function(t, e, i, o) {
                            var n, s, a, r = d.stamp(i), h = "_leaflet_" + e + r;
                            return t[h] ? this : (n = function(e) {
                                return i.call(o || t, e || d.DomEvent._getEvent());
                            }
                                ,
                                d.Browser.pointer && 0 === e.indexOf("touch") ? this.addPointerListener(t, e, n, r) : (d.Browser.touch && "dblclick" === e && this.addDoubleTapListener && this.addDoubleTapListener(t, n, r),
                                    "addEventListener" in t ? "mousewheel" === e ? (t.addEventListener("DOMMouseScroll", n, !1),
                                        t.addEventListener(e, n, !1)) : "mouseenter" === e || "mouseleave" === e ? (s = n,
                                            a = "mouseenter" === e ? "mouseover" : "mouseout",
                                            n = function(e) {
                                                if(d.DomEvent._checkMouse(t, e))
                                                    return s(e);
                                            }
                                            ,
                                            t.addEventListener(a, n, !1)) : "click" === e && d.Browser.android ? (s = n,
                                                n = function(t) {
                                                    return d.DomEvent._filterClick(t, s);
                                                }
                                                ,
                                                t.addEventListener(e, n, !1)) : t.addEventListener(e, n, !1) : "attachEvent" in t && t.attachEvent("on" + e, n),
                                    t[h] = n,
                                    this));
                        },
                        removeListener: function(t, e, i) {
                            var o = d.stamp(i)
                                , n = "_leaflet_" + e + o
                                , s = t[n];
                            return s ? (d.Browser.pointer && 0 === e.indexOf("touch") ? this.removePointerListener(t, e, o) : d.Browser.touch && "dblclick" === e && this.removeDoubleTapListener ? this.removeDoubleTapListener(t, o) : "removeEventListener" in t ? "mousewheel" === e ? (t.removeEventListener("DOMMouseScroll", s, !1),
                        ...
                        disableClickPropagation: function(t) {
                            for(var e = d.DomEvent.stopPropagation, i = d.Draggable.START.length - 1;i >= 0;i--)
                                d.DomEvent.on(t, d.Draggable.START[i], e);
                        ...
                        getMousePosition: function(t, e) {
                            if(!e)
                                return new d.Point(t.clientX, t.clientY);
                        ...
                        _filterClick: function(t, e) {
                            ...
                            if(!(o && o > 100 && o < 500 || t.target._simulatedClick && !t._simulated))
                                return d.DomEvent._lastClick = i,
                                    e(t);
                            d.DomEvent.stop(t);
                        }
                    },
                    ...
                    d.Draggable = d.Class.extend({
                        ...
                        enable: function() {
                            if(!this._enabled) {
                                for(var t = d.Draggable.START.length - 1;t >= 0;t--)
                                    d.DomEvent.on(this._dragStartTarget, d.Draggable.START[t], this._onDown, this);
                                this._enabled = !0;
                            }
                        },
                        disable: function() {
                            if(this._enabled) {
                                for(var t = d.Draggable.START.length - 1;t >= 0;t--)
                                    d.DomEvent.off(this._dragStartTarget, d.Draggable.START[t], this._onDown, this);
                                this._enabled = !1,
                                    this._moved = !1;
                            }
                        },
                        _onDown: function(t) {
                            if(this._moved = !1,
                                !t.shiftKey && (1 === t.which || 1 === t.button || t.touches) && (d.DomEvent.stopPropagation(t),
                                    !d.Draggable._disabled && (d.DomUtil.disableImageDrag(),
                                        d.DomUtil.disableTextSelection(),
                                        !this._moving))) {
                                var e = t.touches ? t.touches[0] : t;
                                this._startPoint = new d.Point(e.clientX, e.clientY),
                                    this._startPos = this._newPos = d.DomUtil.getPosition(this._element),
                                    d.DomEvent.on(a, d.Draggable.MOVE[t.type], this._onMove, this).on(a, d.Draggable.END[t.type], this._onUp, this);
                            }
                        },
                        _onMove: function(t) {
                            if(t.touches && t.touches.length > 1)
                                ...
                                (i.x || i.y) && (d.Browser.touch && Math.abs(i.x) + Math.abs(i.y) < 3 || (d.DomEvent.preventDefault(t),
                                    this._moved || (this.fire("dragstart"),
                                        this._moved = !0,
                                        this._startPos = d.DomUtil.getPosition(this._element).subtract(i),
                                        d.DomUtil.addClass(a.body, "leaflet-dragging"),
                                        this._lastTarget = t.target || t.srcElement,
                                        d.DomUtil.addClass(this._lastTarget, "leaflet-drag-target")),
                        ...
                        _onUp: function() {
                            for(var t in d.DomUtil.removeClass(a.body, "leaflet-dragging"),
                                this._lastTarget && (d.DomUtil.removeClass(this._lastTarget, "leaflet-drag-target"),
                                    this._lastTarget = null),
                                d.Draggable.MOVE)
                                d.DomEvent.off(a, d.Draggable.MOVE[t], this._onMove).off(a, d.Draggable.END[t], this._onUp);
                    ...
                    d.Map.Drag = d.Handler.extend({
                        addHooks: function() {
                            if(!this._draggable) {
                                var t = this._map;
                                this._draggable = new d.Draggable(t._mapPane, t._container),
                                    this._draggable.on({
                        ...
                        _onDragEnd: function(t) {
                            ...
                            if(e.fire("dragend", t),
                                ...
                                u.x && u.y ? (u = e._limitOffset(u, e.options.maxBounds),
                    ...
                    d.Map.ScrollWheelZoom = d.Handler.extend({
                        ...
                        removeHooks: function() {
                            d.DomEvent.off(this._map._container, "mousewheel", this._onWheelScroll),
                                d.DomEvent.off(this._map._container, "MozMousePixelScroll", d.DomEvent.preventDefault);
                        },
                        _onWheelScroll: function(t) {
                            ...
                            clearTimeout(this._timer),
                                ...
                                d.DomEvent.preventDefault(t),
                                d.DomEvent.stopPropagation(t);
                        },
                    ...
                    d.extend(d.DomEvent, {
                        ...
                        addDoubleTapListener: function(t, e, i) {
                            var o, n, s = !1, r = "_leaflet_", h = this._touchstart, l = this._touchend, c = [];
                            function p(t) {
                                var e;
                                if(d.Browser.pointer ? (c.push(t.pointerId),
                                    e = c.length) : e = t.touches.length,
                                    !(e > 1)) {
                                    var i = Date.now()
                                        , a = i - (o || i);
                            ...
                            function _(t) {
                                ...
                                if(s) {
                                    if(d.Browser.pointer) {
                                        ...
                                        for(var h in n)
                                            a = n[h],
                                                r[h] = "function" == typeof a ? a.bind(n) : a;
                                        n = r;
                                    }
                                    n.type = "dblclick",
                                        e(n),
                            ...
                            return t.addEventListener(h, p, !1),
                                u.addEventListener(l, _, !1),
                                d.Browser.pointer && u.addEventListener(d.DomEvent.POINTER_CANCEL, _, !1),
                                this;
                        },
                        removeDoubleTapListener: function(t, e) {
                            var i = "_leaflet_";
                            return t.removeEventListener(this._touchstart, t[i + this._touchstart + e], !1),
                                (d.Browser.pointer ? a.documentElement : t).removeEventListener(this._touchend, t[i + this._touchend + e], !1),
                                d.Browser.pointer && a.documentElement.removeEventListener(d.DomEvent.POINTER_CANCEL, t[i + this._touchend + e], !1),
                                this;
                        }
                    }),
                    d.extend(d.DomEvent, {
                        ...
                        addPointerListenerStart: function(t, e, i, o) {
                            ...
                            if(t["_leaflet_touchstart" + o] = s,
                                ...
                                a.documentElement.addEventListener(this.POINTER_UP, r, !1),
                                    a.documentElement.addEventListener(this.POINTER_CANCEL, r, !1),
                        ...
                        addPointerListenerMove: function(t, e, i, o) {
                            ...
                            return t["_leaflet_touchmove" + o] = s,
                        ...
                        addPointerListenerEnd: function(t, e, i, o) {
                            ...
                            return t["_leaflet_touchend" + o] = s,
                    ...
                    d.Map.TouchZoom = d.Handler.extend({
                        ...
                        _onTouchStart: function(t) {
                            ...
                            if(t.touches && 2 === t.touches.length && !e._animatingZoom && !this._zooming) {
                                ...
                                this._startCenter = i.add(o)._divideBy(2),
                                    ...
                                    d.DomEvent.on(a, "touchmove", this._onTouchMove, this).on(a, "touchend", this._onTouchEnd, this),
                                    d.DomEvent.preventDefault(t);
                            }
                        },
                        _onTouchMove: function(t) {
                            ...
                            if(t.touches && 2 === t.touches.length && this._zooming) {
                                var i = e.mouseEventToLayerPoint(t.touches[0])
                                    , o = e.mouseEventToLayerPoint(t.touches[1]);
                                this._scale = i.distanceTo(o) / this._startDist,
                                    this._delta = i._add(o)._divideBy(2)._subtract(this._startCenter),
                                    1 !== this._scale && (!e.options.bounceAtZoomLimits && (e.getZoom() === e.getMinZoom() && this._scale < 1 || e.getZoom() === e.getMaxZoom() && this._scale > 1) || (this._moved || (d.DomUtil.addClass(e._mapPane, "leaflet-touching"),
                        ...
                        _onTouchEnd: function() {
                            if(this._moved && this._zooming) {
                                var t = this._map;
                                this._zooming = !1,
                                    d.DomUtil.removeClass(t._mapPane, "leaflet-touching"),
                                    d.Util.cancelAnimFrame(this._animRequest),
                                    d.DomEvent.off(a, "touchmove", this._onTouchMove).off(a, "touchend", this._onTouchEnd);
                    ...
                    d.Map.Tap = d.Handler.extend({
                        ...
                        _onDown: function(t) {
                            if(t.touches) {
                                if(d.DomEvent.preventDefault(t),
                                    this._fireClick = !0,
                                    t.touches.length > 1)
                                ...
                                var e = t.touches[0]
                                    , i = e.target;
                                this._startPos = this._newPos = new d.Point(e.clientX, e.clientY),
                                    i.tagName && "a" === i.tagName.toLowerCase() && d.DomUtil.addClass(i, "leaflet-active"),
                                    ...
                                    d.DomEvent.on(a, "touchmove", this._onMove, this).on(a, "touchend", this._onUp, this);
                            }
                        },
                        _onUp: function(t) {
                            if(clearTimeout(this._holdTimeout),
                                d.DomEvent.off(a, "touchmove", this._onMove, this).off(a, "touchend", this._onUp, this),
                                this._fireClick && t && t.changedTouches) {
                                var e = t.changedTouches[0]
                                    , i = e.target;
                                i && i.tagName && "a" === i.tagName.toLowerCase() && d.DomUtil.removeClass(i, "leaflet-active"),
                    ...
                    d.Map.BoxZoom = d.Handler.extend({
                        ...
                        _onMouseDown: function(t) {
                            ...
                            d.DomUtil.disableTextSelection(),
                                ...
                                d.DomEvent.on(a, "mousemove", this._onMouseMove, this).on(a, "mouseup", this._onMouseUp, this).on(a, "keydown", this._onKeyDown, this);
                        },
                        _onMouseMove: function(t) {
                            this._moved || (this._box = d.DomUtil.create("div", "leaflet-zoom-box", this._pane),
                            ...
                            d.DomUtil.setPosition(i, s),
                                this._moved = !0,
                                i.style.width = Math.max(0, Math.abs(n.x) - 4) + "px",
                                i.style.height = Math.max(0, Math.abs(n.y) - 4) + "px";
                        },
                        _finish: function() {
                            this._moved && (this._pane.removeChild(this._box),
                                ...
                                d.DomUtil.enableTextSelection(),
                                d.DomUtil.enableImageDrag(),
                                d.DomEvent.off(a, "mousemove", this._onMouseMove).off(a, "mouseup", this._onMouseUp).off(a, "keydown", this._onKeyDown);
                        },
                    ...
                    d.Map.Keyboard = d.Handler.extend({
                        ...
                        addHooks: function() {
                            ...
                            -1 === t.tabIndex && (t.tabIndex = "0"),
                                d.DomEvent.on(t, "focus", this._onFocus, this).on(t, "blur", this._onBlur, this).on(t, "mousedown", this._onMouseDown, this),
                                this._map.on("focus", this._addHooks, this).on("blur", this._removeHooks, this);
                        },
                        removeHooks: function() {
                            this._removeHooks();
                            var t = this._map._container;
                            d.DomEvent.off(t, "focus", this._onFocus, this).off(t, "blur", this._onBlur, this).off(t, "mousedown", this._onMouseDown, this),
                    ...
                    d.Handler.MarkerDrag = d.Handler.extend({
                        ...
                        addHooks: function() {
                            ...
                            this._draggable || (this._draggable = new d.Draggable(t, t)),
                                this._draggable.on("dragstart", this._onDragStart, this).on("drag", this._onDrag, this).on("dragend", this._onDragEnd, this),
                                this._draggable.enable(),
                                d.DomUtil.addClass(this._marker._icon, "leaflet-marker-draggable");
                        },
                        removeHooks: function() {
                    ...
                    d.Control = d.Class.extend({
                        ...
                        addTo: function(t) {
                            ...
                            return d.DomUtil.addClass(e, "leaflet-control"),
                    ...
                    d.Control.Zoom = d.Control.extend({
                        ...
                        _createButton: function(t, e, i, o, n, s) {
                            ...
                            return d.DomEvent.on(a, "click", r).on(a, "mousedown", r).on(a, "dblclick", r).on(a, "click", d.DomEvent.preventDefault).on(a, "click", n, s).on(a, "click", this._refocusOnMap, s),
                                a;
                        },
                        _updateDisabled: function() {
                            var t = this._map
                                , e = "leaflet-disabled";
                            d.DomUtil.removeClass(this._zoomInButton, e),
                                d.DomUtil.removeClass(this._zoomOutButton, e),
                                t._zoom === t.getMinZoom() && d.DomUtil.addClass(this._zoomOutButton, e),
                                t._zoom === t.getMaxZoom() && d.DomUtil.addClass(this._zoomInButton, e);
                        }
                    }),
                    d.Map.mergeOptions({
                        zoomControl: !0
                    ...
                    d.Control.Attribution = d.Control.extend({
                        ...
                        onAdd: function(t) {
                            for(var e in this._container = d.DomUtil.create("div", "leaflet-control-attribution"),
                    ...
                    d.Control.Scale = d.Control.extend({
                        ...
                        _addScales: function(t, e, i) {
                            t.metric && (this._mScale = d.DomUtil.create("div", e + "-line", i)),
                                t.imperial && (this._iScale = d.DomUtil.create("div", e + "-line", i));
                        },
                        _update: function() {
                            var t = this._map.getBounds()
                                ...
                                , n = this.options
                                , s = 0;
                            o.x > 0 && (s = i * (n.maxWidth / o.x)),
                                this._updateScales(n, s);
                        },
                        ...
                        _updateImperial: function(t) {
                            var e, i, o, n = 3.2808399 * t, s = this._iScale;
                            n > 5280 ? (e = n / 5280,
                                i = this._getRoundNum(e),
                                s.style.width = this._getScaleWidth(i / e) + "px",
                                s.innerHTML = i + " mi") : (o = this._getRoundNum(n),
                                    s.style.width = this._getScaleWidth(o / n) + "px",
                                    s.innerHTML = o + " ft");
                        },
                    ...
                    d.Control.Layers = d.Control.extend({
                        ...
                        initialize: function(t, e, i) {
                            for(var o in d.setOptions(this, i),
                                this._layers = {},
                                this._lastZIndex = 0,
                        ...
                        _initLayout: function() {
                            ...
                            e.setAttribute("aria-haspopup", !0),
                                d.Browser.touch ? d.DomEvent.on(e, "click", d.DomEvent.stopPropagation) : d.DomEvent.disableClickPropagation(e).disableScrollPropagation(e);
                            ...
                            if(this.options.collapsed) {
                                ...
                                o.href = "#",
                                    o.title = "Layers",
                                    d.Browser.touch ? d.DomEvent.on(o, "click", d.DomEvent.stop).on(o, "click", this._expand, this) : d.DomEvent.on(o, "focus", this._expand, this),
                                    d.DomEvent.on(i, "click", (function() {
                                ...
                                this._expand();
                            this._baseLayersList = d.DomUtil.create("div", t + "-base", i),
                                this._separator = d.DomUtil.create("div", t + "-separator", i),
                                this._overlaysList = d.DomUtil.create("div", t + "-overlays", i),
                                e.appendChild(i);
                        },
                        ...
                        _addItem: function(t) {
                            var e, i = a.createElement("label"), o = this._map.hasLayer(t.layer);
                            t.overlay ? ((e = a.createElement("input")).type = "checkbox",
                                e.className = "leaflet-control-layers-selector",
                                e.defaultChecked = o) : e = this._createRadioElement("leaflet-base-layers", o),
                                e.layerId = d.stamp(t.layer),
                                d.DomEvent.on(e, "click", this._onInputClick, this);
                            var n = a.createElement("span");
                            return n.innerHTML = " " + t.name,
                                i.appendChild(e),
                                i.appendChild(n),
                        ...
                        _onInputClick: function() {
                            var t, e, i, o = this._form.getElementsByTagName("input"), n = o.length;
                    ...
                    d.PosAnimation = d.Class.extend({
                        ...
                        run: function(t, e, i, o) {
                            this.stop(),
                                ...
                                this._newPos = e,
                                this.fire("start"),
                                t.style[d.DomUtil.TRANSITION] = "all " + (i || .25) + "s cubic-bezier(0,0," + (o || .5) + ",1)",
                                d.DomEvent.on(t, d.DomUtil.TRANSITION_END, this._onTransitionEnd, this),
                                d.DomUtil.setPosition(t, e),
                        ...
                        _getPos: function() {
                            var t, e, i, o = this._el, n = s.getComputedStyle(o);
                            if(d.Browser.any3d) {
                                if(!(i = n[d.DomUtil.TRANSFORM].match(this._transformRe)))
                                    return;
                                t = parseFloat(i[1]),
                                    e = parseFloat(i[2]);
                            } else
                    ...
                    d.Map.include({
                        setView: function(t, e, i) {
                            if((e = e === r ? this._zoom : this._limitZoom(e),
                                t = this._limitCenter(d.latLng(t), e, this.options.maxBounds),
                                i = i || {},
                                this._panAnim && this._panAnim.stop(),
                                this._loaded && !i.reset && !0 !== i) && (i.animate !== r && (i.zoom = d.extend({
                                    animate: i.animate
                                }, i.zoom),
                                    i.pan = d.extend({
                                        animate: i.animate
                    ...
                    d.PosAnimation = d.DomUtil.TRANSITION ? d.PosAnimation : d.PosAnimation.extend({
                        run: function(t, e, i, o) {
                            this.stop(),
                                ...
                                this._startPos = d.DomUtil.getPosition(t),
                        ...
                        _runFrame: function(t) {
                            ...
                            d.DomUtil.setPosition(this._el, e),
                                this.fire("step");
                        },
                        _complete: function() {
                    ...
                    d.DomUtil.TRANSITION && d.Map.addInitHook((function() {
                        this._zoomAnimated = this.options.zoomAnimation && d.DomUtil.TRANSITION && d.Browser.any3d && !d.Browser.android23 && !d.Browser.mobileOpera,
                            this._zoomAnimated && d.DomEvent.on(this._mapPane, d.DomUtil.TRANSITION_END, this._catchTransitionEnd, this);
                    }
                    )),
                    d.Map.include(d.DomUtil.TRANSITION ? {
                        ...
                        _tryAnimatedZoom: function(t, e, i) {
                            ...
                            return !(!0 !== i.animate && !this.getSize().contains(n)) && (this.fire("movestart").fire("zoomstart"),
                                this._animateZoom(t, e, s, o, null, !0),
                                !0);
                        },
                    ...
                    d.TileLayer.include({
                        ...
                        _getLoadedTilesPercentage: function(t) {
                            var e, i, o = t.getElementsByTagName("img"), n = 0;
                            for(e = 0,
                                i = o.length;e < i;e++)
                                o[e].complete && n++;
                            return n / i;
                        ...
                        _stopLoadingImages: function(t) {
                            ...
                            for(e = 0,
                                i = n.length;e < i;e++)
                                (o = n[e]).complete || (o.onload = d.Util.falseFn,
                                    o.onerror = d.Util.falseFn,
                                    o.src = d.Util.emptyImageUrl,
                    ...
                    d.Map.include({
                        ...
                        locate: function(t) {
                            if(t = this._locateOptions = d.extend(this._defaultLocateOptions, t),
                        ...
                        _handleGeolocationResponse: function(t) {
                            ...
                            for(var c in t.coords)
                                "number" == typeof t.coords[c] && (l[c] = t.coords[c]);
    ...
    function i(o) {
        ...
        return t[o](s, s.exports, i),
            s.exports;
    }
    i.d = (t, e) => {
        for(var o in e)
            i.o(e, o) && !i.o(t, o) && Object.defineProperty(t, o, {
                enumerable: !0,
                get: e[o]
            });
    }
    ...
    (() => {
        ...
        const t = navigator.userAgent.toLowerCase()
            ...
            , g = (window.opera,
                !window.L_NO_TOUCH && !r && (d || "ontouchstart" in window || window.DocumentTouch && document instanceof window.DocumentTouch));
        ...
        const y = -1 !== t.indexOf("chrome")
            ...
            , k = function() {
                var t = "portrait";
                return window.innerWidth > window.innerHeight && (t = "landscape"),
        ...
        function T(t, ...e) {
            for(let o of e)
                for(var i of Object.getOwnPropertyNames(o.prototype))
                    t.prototype[i] = o.prototype[i];
        }
        function D(t, e) {
            var i;
            for(i in e)
        ...
        function C(t, e) {
            var i = function() {
                var t;
                return "abcdefghijklmnopqurstuvwxyz".substr((t = 32,
        ...
        let I = new class {
            ...
            createNode(t, e) {
                ...
                for(i in e)
                    e.hasOwnProperty(i) && o.setAttribute(i, e[i]);
                return o;
            }
            finish(t) {
                ...
                o && (e = o.callback,
                    (i = o.urls).shift(),
                    this.pollCount = 0,
                    i.length || (e && e.call(o.context, o.obj),
                        this.pending[t] = null,
            ...
            load(t, e, i, o, n) {
                ...
                if(e)
                    if(e = "string" == typeof e ? [e] : e.concat(),
                        p || this.env.async || this.env.gecko || this.env.opera)
                        this.queue[t].push({
                            urls: e,
                            callback: i,
                            obj: o,
                ...
                if(!this.pending[t] && (h = this.pending[t] = this.queue[t].shift())) {
                    for(s = 0,
                        a = (l = h.urls).length;s < a;++s)
                        c = l[s],
                            p ? r = this.env.gecko ? this.createNode("style") : this.createNode("link", {
                                href: c,
                                rel: "stylesheet"
                            ...
                            this.env.ie && !p ? r.onreadystatechange = function() {
                                /loaded|complete/.test(r.readyState) && (r.onreadystatechange = null,
                                    d());
                            }
                                : p && (this.env.gecko || this.env.webkit) ? this.env.webkit ? (h.urls[s] = r.href,
                                    this.pollWebKit()) : (r.innerHTML = '@import "' + c + '";',
                                        this.pollGecko(r)) : r.onload = r.onerror = d,
                            _.push(r);
                    for(s = 0,
                        a = _.length;s < a;++s)
                        this.head.appendChild(_[s]);
                }
            }
            pollGecko(t) {
                var e;
        ...
        class N {
            ...
            static getTranslateString(t) {
                return N.TRANSLATE_OPEN + t.x + "px," + t.y + "px" + N.TRANSLATE_CLOSE;
            }
            static setPosition(t, e) {
                t._vco_pos = e,
                    Browser.webkit3d ? (t.style[N.TRANSFORM] = N.getTranslateString(e),
                        Browser.android && (t.style["-webkit-perspective"] = "1000",
                            t.style["-webkit-backface-visibility"] = "hidden")) : (t.style.left = e.x + "px",
                                t.style.top = e.y + "px");
            }
        ...
        class Z {
            ...
            easeInSpline(t) {
                return new Z.KeySpline(U).get(t);
            }
            easeInOutExpo(t) {
                return new Z.KeySpline(U).get(t);
            }
        ...
        function W(t) {
            return j = function(t) {
                var e = i(329)(`./${t}.json`);
                for(let t in R)
                    e[t] ? "object" == typeof R[t] && (e[t] = Object.assign(R[t], e[t])) : e[t] = R[t];
                return e;
            }(t),
                j;
        }
        class H {
            ...
            off(t, e, i) {
                ...
                for(var o = 0, n = this._vco_events, s = n[t].length;o < s;o++)
                    if(n[t][o].action === e && (!i || n[t][o].context === i))
                        return n[t].splice(o, 1),
                            this;
                return this;
            }
            fire(t, e) {
                ...
                for(var i = P({
                    type: t,
                    target: this
                }, e), o = this._vco_events[t].slice(), n = 0, s = o.length;n < s;n++)
                    o[n].action.call(o[n].context || this, i);
                return this;
            }
        }
        class F {
            ...
            animatePosition(t, e, i) {
                ...
                for(var n in t)
                    t.hasOwnProperty(n) && (o[n] = i ? t[n] + "%" : t[n] + "px");
                this.animator && this.animator.stop(),
                    this.animator = VCO.Animate(e, o);
            }
            onLoaded() {
        ...
        class V {
            constructor(t, e, i) {
                this._el = {
                    ...
                    this._el.container = "object" == typeof t ? t : N.get(t),
                    this._loaded = {
                        data: !1,
                        map: !1
                    },
            ...
            goTo(t, e) {
                if(t < this._markers.length && t >= 0) {
                    ...
                    if(this.animator && this.animator.stop(),
                        ...
                        n.data.type && "overview" == n.data.type)
                        this._markerOverview(),
                            e || this._onMarkerChange();
                    else if(n.active(!0),
                        e)
                        n.data.location && this._viewTo(n.data.location);
                    else {
                        if(n.data.location && n.data.location.lat)
                            if(i = this._calculateZoomChange(this._getMapCenter(!0), n.location()),
                                this._viewTo(n.data.location, {
                                ...
                                if(this.options.show_history_line && n.data.real_marker && this._markers[o].data.real_marker) {
                                    ...
                                    if(r < this.current_marker)
                                        for(;r < this.current_marker;)
                                            this._markers[r].data.location && this._markers[r].data.location.lat && (s = {
                                ...
                                this.options.show_history_line && n.data.real_marker && this._markers[o].data.real_marker && this._replaceLines(this._line_active, [{
                                    lat: n.data.location.lat,
                                    lon: n.data.location.lon
                                }, {
            ...
            setMapOffset(t, e) {
                this.options.map_center_offset.left = t,
                    this.options.map_center_offset.top = e;
            }
            calculateMinMaxZoom() {
                for(var t = 0;t < this._markers.length;t++)
                    this._markers[t].data.location && this._markers[t].data.location.zoom && this.updateMinMaxZoom(this._markers[t].data.location.zoom);
            }
            updateMinMaxZoom(t) {
                this.zoom_min_max.max || (this.zoom_min_max.max = t),
                    this.zoom_min_max.min || (this.zoom_min_max.min = t),
                    this.zoom_min_max.max < t && (this.zoom_min_max.max = t),
                    this.zoom_min_max.min > t && (this.zoom_min_max.min = t);
            }
            initialMapLocation() {
                this._loaded.data && this._loaded.map && (this.goTo(this.options.start_at_slide, !0),
            ...
            _destroyMarker(t) {
                ...
                for(var e = 0;e < this._markers.length;e++)
                    this._markers[e] == t && this._markers.splice(e, 1);
                this.fire("markerRemoved", t);
            }
            _createMarkers(t) {
                for(var e = 0;e < t.length;e++)
                    this._createMarker(t[e]),
                        t[e].location && t[e].location.lat && this.options.show_lines && this._addToLine(this._line, t[e]);
            }
            _createLines(t) {}
            _createMap() {}
            _createMiniMap() {}
            _createMarker(t) {
                var e = {};
                e.on("markerclick", this._onMarkerClick),
                    this._addMarker(e),
                    this._markers.push(e),
                    e.marker_number = this._markers.length - 1,
                    this.fire("markerAdded", e);
            }
            _addMarker(t) {}
            _removeMarker(t) {}
            _resetMarkersActive() {
                for(var t = 0;t < this._markers.length;t++)
                    this._markers[t].active(!1);
            }
            ...
            _onMapLoaded(t) {
                this._loaded.map = !0,
                    this.options.calculate_zoom && this.calculateMarkerZooms(),
                    this.calculateMinMaxZoom(),
                    this.options.map_mini && !x && this.createMiniMap(),
            ...
            _scollZoom(t) {
                ...
                this.scroll.start_time = null,
                    ...
                    this.zoomTo(Math.round(i * this.touch_scale));
            }
            _scollZoomDone(t) {
                this.touch_scale = 1;
            }
            ...
            _initLayout() {
                this._el.map_mask = N.create("div", "vco-map-mask", this._el.container),
                    this.options.map_as_image ? this._el.map = N.create("div", "vco-map-display vco-mapimage-display", this._el.map_mask) : this._el.map = N.create("div", "vco-map-display", this._el.map_mask);
            }
            _initData() {
                this.data.slides && (this._createMarkers(this.data.slides),
                    this._resetMarkersActive(),
                    this._markers[this.current_marker].active(!0),
                    this._loaded.data = !0,
                    this._initialMapLocation());
            }
            _initEvents() {
        ...
        class q extends L.TileLayer {
            constructor(t, e = G) {
                super(t, e),
                    e = L.setOptions(this, e),
                    this._url = t,
                    e.width || (e.width = 600),
                    e.height || (e.width = 600);
                var i = L.point(e.width, e.height)
                    , o = e.tileSize;
                for(this._imageSize = [i],
                    this._gridSize = [this._getGridSize(i)];i.x > o || i.y > o;)
                    i = i.divideBy(2).floor(),
                        this._imageSize.push(i),
                        this._gridSize.push(this._getGridSize(i));
            ...
            _getBestFitZoom(t) {
                for(var e, i = this.options.tolerance, o = this._imageSize.length - 1;o;) {
                    if((e = this._imageSize[o]).x * i < t.x && e.y * i < t.y)
                        return o;
                    o--;
                }
                return o;
            ...
            _tileShouldBeLoaded(t) {
                ...
                return e ? t.x >= 0 && t.x < e.x && t.y >= 0 && t.y < e.y : (console.log("_tileShouldBeLoaded: No gridSize for " + this._map.getZoom()),
                    !1);
            }
            _addTile(t, e) {
                var i = this._getTilePos(t)
                ...
                t.x === a.x - 1 && (o.style.width = s.x - r * (a.x - 1) + "px"),
                    t.y === a.y - 1 && (o.style.height = s.y - r * (a.y - 1) + "px"),
                    L.DomUtil.setPosition(o, i, L.Browser.chrome || L.Browser.android23),
                    this._tiles[t.x + ":" + t.y] = o,
                    this._loadTile(o, t),
                    o.parentNode !== this._tileContainer && e.appendChild(o);
            }
            ...
            _getTileGroup(t) {
                var e, i = this._map.getZoom(), o = 0;
                for(let t = 0;t < i;t++)
                    o += (e = this._gridSize[t]).x * e.y;
                return o += t.y * this._gridSize[i].x + t.x,
                    Math.floor(o / 256);
            }
        }
        const J = {
        ...
        class K extends L.Control {
            constructor(t, e) {
                let i = Object.assign({}, J, e);
                super(t, i),
                ...
                return this._mainMap = t,
                    ...
                    this._miniMap.whenReady(L.Util.bind((function() {
                        this._aimingRect = L.rectangle(this._mainMap.getBounds(), this.options.aimingRectOptions).addTo(this._miniMap),
                            ...
                            this.options.bounds_array && this._miniMap.fitBounds(this.options.bounds_array, {
                                padding: [15, 15]
                            });
                    }
                    ), this)),
            ...
            restore() {
                this._minimized && (this._restore(),
                    this._miniMap.fitBounds(this.options.bounds_array, {
                        padding: [15, 15]
                    }));
            }
            addTo(t) {
                return L.Control.prototype.addTo.call(this, t),
            ...
            _createButton(t, e, i, o, n, s) {
                ...
                return L.DomEvent.on(a, "click", r).on(a, "mousedown", r).on(a, "dblclick", r).on(a, "click", L.DomEvent.preventDefault).on(a, "click", n, s),
                    a;
            }
            _toggleDisplayButtonClicked() {
                this._userToggledDisplay = !0,
                    this._minimized ? (this._restore(),
                        this._toggleDisplayButton.title = this.hideText) : (this._minimize(),
            ...
            _onMainMapMoved(t) {
                ...
                this.options.show_view && this._aimingRect.setBounds(this._mainMap.getBounds()),
            ...
            _decideZoom(t) {
                if(this.options.zoomLevelFixed || 0 == this.options.zoomLevelFixed)
                    return t ? this.options.zoomLevelFixed : this._mainMap.getZoom();
                if(t)
                    return this._mainMap.getZoom() + this.options.zoomLevelOffset;
                var e, i = this._miniMap.getZoom() - this._mainMap.getZoom(), o = this._miniMap.getZoom() - this.options.zoomLevelOffset;
                return i > this.options.zoomLevelOffset && this._mainMap.getZoom() < this._miniMap.getMinZoom() - this.options.zoomLevelOffset ? this._miniMap.getZoom() > this._lastMiniMapZoom ? (e = this._mainMap.getZoom() + 1,
                    this._miniMap.setZoom(this._miniMap.getZoom() - 1)) : e = this._mainMap.getZoom() : e = o,
        ...
        class X extends Y {
            _createMarker(t, e) {
                if(t.location && "number" == typeof t.location.lat && "number" == typeof t.location.lon) {
                    ...
                    i && t.location.icon ? (this._custom_icon = {
                        ...
                        this._icon = this._createIcon()) : i && t.location.image ? (this._custom_image_icon = t.location.image,
                            this._icon = this._createImage()) : this._icon = this._createDefaultIcon(!1),
                        this._marker = new L.marker([t.location.lat, t.location.lon], {
                            title: t.text.headline,
                            icon: this._icon
                        }),
                        this._marker.on("click", this._onMarkerClick, this),
                        e.map_popup && this._createPopup(t, e);
                }
            }
            _addTo(t) {
            ...
            _createPopup(t, e) {}
            _active(t) {
                this.data.media && this.data.media.mediatype ? this.media_icon_class = "vco-mapmarker-icon vco-icon-" + this.data.media.mediatype.type : this.media_icon_class = "vco-mapmarker-icon vco-icon-plaintext",
                    this.data.real_marker && (t ? this._marker.setZIndexOffset(100) : (clearTimeout(this.timer),
                        this._marker.setZIndexOffset(0)),
                        this._custom_icon ? this._icon = this._createIcon() : this._custom_image_icon ? this._icon = this._createImage(t) : this._icon = this._createDefaultIcon(t),
                        this._setIcon());
            }
            _createIcon() {
                return new L.icon({
        ...
        function $(t, e, i, o) {
            return {
                url: ["https://tiles.stadiamaps.com/tiles/", t = t.replace("-", "_"), "/{Z}/{X}/{Y}.", e].join(""),
                type: e,
                subdomains: "",
                minZoom: i,
                maxZoom: o,
        ...
        let Q = {
            toner: $("stamen_toner", "png", 0, 20),
            terrain: $("stamen_terrain", "jpg", 4, 18),
            watercolor: $("stamen_watercolor", "jpg", 0, 16),
            ch_watercolor: {
        ...
        function tt(t, e, i) {
            for(var o = et(t), n = 0;n < e.length;n++) {
                var s = [t, e[n]].join("-");
                Q[s] = $(`stamen_ ${s}`, i || o.type, o.minZoom, o.maxZoom);
            }
        }
        function et(t) {
            if("trees-cabs-crime" == t && (console.log("trees-cabs-crime is not available. Using toner instead"),
                t = "toner"),
                t in Q)
                return Q[t];
            throw "No such provider (" + t + ")";
        }
        tt("toner", ["hybrid", "labels", "lines", "background", "lite"]),
            tt("toner", ["2010"]),
            tt("toner", ["2011", "2011-lines", "2011-labels", "2011-lite"]),
            tt("terrain", ["background"]),
            tt("terrain", ["labels", "lines"], "png");
        class it extends L.TileLayer {
            constructor(t, e) {
                ...
                e && D(n, e),
                    L.TileLayer.prototype.initialize.call(this, o, n);
            }
        }
        class ot extends V {
            _createMap() {
                this._map = new L.map(this._el.map, {
                    ...
                    this._image_layer && this._map.addLayer(this._image_layer),
            ...
            _createMiniMap() {
                this.options.map_as_image && (this.zoom_min_max.min = 0),
                    this.bounds_array || (this.bounds_array = this._getAllMarkersBounds(this._markers)),
                    this._tile_layer_mini = this._createTileLayer(this.options.map_type),
                    this._mini_map = new K(this._tile_layer_mini, {
                        width: 150,
                        height: 100,
                        position: "topleft",
            ...
            _createBackgroundMap(t) {
                if(this._image_layer ? this._image_layer.clearLayers() : (this._image_layer = new L.layerGroup,
                    ...
                    for(let s in t) {
                        ...
                        if(i.style.left || i.style.top)
                            i.style.left && (o.x = parseInt(i.style.left.split("px")[0])),
                                i.style.top && (o.y = parseInt(i.style.top.split("px")[0]));
                        else if(i.style["-webkit-transform"] || i.style.transform || i.style["-ms-transform"]) {
                            var n;
                            i.style["-webkit-transform"] ? n = i.style["-webkit-transform"].split("3d(")[1].split(", 0)")[0].split(", ") : i.style.transform ? n = i.style.transform.split("3d(")[1].split(", 0)")[0].split(", ") : i.style["-ms-transform"] && (n = i.style["-ms-transform"].split("3d(")[1].split(", 0)")[0].split(", ")),
                                o.x = parseInt(n[0].split("px")[0]),
                                o.y = parseInt(n[1].split("px")[0]);
                        }
                        o.url.match("toner") && (o.url = o.url.replace("/toner-hybrid/", "/toner-lines/"),
                            o.url = o.url.replace("/toner/", "/toner-background/")),
                            o.pos.start = this._map.containerPointToLatLng([o.x, o.y]),
                            o.pos.end = this._map.containerPointToLatLng([o.x + o.width, o.y + o.height]),
                            e = new L.imageOverlay(o.url, [o.pos.start, o.pos.end]),
                            this._image_layer.addLayer(e);
                    }
            }
            _createTileLayer(t, e) {
                ...
                t || (t = "stamen:toner-lite"),
                    "stamen:trees-cabs-crime" == t && (console.log("stamen:trees-cabs-crime layer no longer available. Using OSM instead"),
                        t = "osm"),
                    M && (e.r = "@2x");
                let n = t.split(":");
                switch(n[0]) {
                    case "mapbox":
                        var s;
                        if(e.attribution = o + "<div class='mapbox-maplogo'></div><a href='https://www.mapbox.com/about/maps/' target='_blank'>© Mapbox © OpenStreetMap</a>",
                            n.length > 2)
                            s = "https://api.mapbox.com/styles/v1/" + n[2].substr(9) + "/tiles/256/{z}/{x}/{y}@2x?access_token=" + this.options.map_access_token;
                        else
                            s = "https://api.tiles.mapbox.com/v4/" + n[1] + "/{z}/{x}/{y}.png?access_token=" + this.options.map_access_token;
                        i = new L.TileLayer(s, e);
                        break;
                    case "stadia":
                        var a;
                        n.length > 1 && (a = n.slice(1).join(":"),
                            this.options.map_access_token && (a = `${a}?api_key=${this.options.map_access_token}`)),
                            i = new L.TileLayer(a, e);
                        break;
                    case "stamen":
                        i = new it(n[1] || "toner-lite", e),
                            this._map.getContainer().style.backgroundColor = "#FFFFFF";
                        break;
                    case "zoomify":
                        e.width = this.options.zoomify.width,
                            e.height = this.options.zoomify.height,
                            e.tolerance = this.options.zoomify.tolerance || .9,
                            e.attribution = o + this.options.zoomify.attribution,
                            i = new q(this.options.zoomify.path, e);
                        break;
                    case "http":
                    case "https":
                        e.subdomains = this.options.map_subdomains,
                            e.attribution = o + this.options.attribution,
                            i = new L.TileLayer(this.options.map_type, e);
                        break;
                    case "ch-watercolor":
                        e.attribution = o + 'Map tiles by <a href="http://stamen.com">Stamen Design</a>, served by <a href="https://watercolormaps.collection.cooperhewitt.org/">Cooper Hewitt, Smithsonian Design Museum</a> under <a href="http://creativecommons.org/licenses/by/3.0">CC BY 3.0</a>. Data by <a href="http://openstreetmap.org">OpenStreetMap</a>, under <a href="http://creativecommons.org/licenses/by-sa/3.0">CC BY SA</a>.',
                            ...
                            e.minZoom = 0,
                            e.maxZoom = 16,
                            i = new L.TileLayer("https://watercolormaps.collection.cooperhewitt.org/tile/watercolor/{z}/{x}/{y}.jpg", e);
                        break;
                    default:
                        e.subdomains = "ab",
                            e.attribution = o + "© <a target='_blank' href='http://www.openstreetmap.org'>OpenStreetMap</a> and contributors, under an <a target='_blank' href='http://www.openstreetmap.org/copyright'>open license</a>",
                            i = new L.TileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png", e);
                }
                return i;
            }
            _onMapMoveEnd(t) {}
            _onTilesLoaded(t) {
                this._createBackgroundMap(t.target._tiles),
            ...
            _onMapZoom(t) {}
            _createMarker(t) {
                var e = new X(t, this.options);
                e.on("markerclick", this._onMarkerClick, this),
                    this._addMarker(e),
                    this._markers.push(e),
                    e.marker_number = this._markers.length - 1,
                    this.fire("markerAdded", e);
            ...
            _markerOverview() {
                ...
                if(this._line_active.setStyle({
                    ...
                    t = i.center,
                        (this.options.map_center_offset && 0 != this.options.map_center_offset.left || 0 != this.options.map_center_offset.top) && (i.zoom = i.zoom - 1,
                            t = this._getMapCenterOffset(t, i.zoom)),
                        this._map.setView(t, i.zoom, {
                            pan: {
                                animate: !0,
                ...
                } else if(this.bounds_array = this._getAllMarkersBounds(this._markers),
                    this.options.map_center_offset && 0 != this.options.map_center_offset.left || 0 != this.options.map_center_offset.top) {
                    var o = new L.latLngBounds(this.bounds_array);
                    t = o.getCenter(),
                        e = this._map.getBoundsZoom(o),
                        t = this._getMapCenterOffset(t, e - 1),
                        this._map.setView(t, e - 1, {
                            pan: {
                                animate: !0,
                                duration: this.options.duration / 1e3,
                                easeLinearity: .1
            ...
            _getAllMarkersBounds(t) {
                for(var e = [], i = 0;i < t.length;i++)
                    t[i].data.real_marker && e.push([t[i].data.location.lat, t[i].data.location.lon]);
                return e;
            }
            _calculateMarkerZooms() {
                for(var t = 0;t < this._markers.length;t++)
                    if(this._markers[t].data.location) {
                        ...
                        o = r.data.type && "overview" == r.data.type ? this._getMapCenter(!0) : r.location(),
                            e = t > 0 ? this._markers[t - 1].location() : this._getMapCenter(!0),
                            n = this._calculateZoomChange(e, o),
                            i = t < this._markers.length - 1 ? this._markers[t + 1].location() : this._getMapCenter(!0),
                            s = this._calculateZoomChange(i, o),
                            a = n && n < s ? n : s || n,
                            (this.options.map_center_offset && 0 != this.options.map_center_offset.left || 0 != this.options.map_center_offset.top) && (a -= 1),
                            r.data.location.zoom = a;
                    }
            }
            _createLine(t) {
            ...
            _viewTo(t, e) {
                ...
                this.options.map_as_image || this._line_active.setStyle({
                    ...
                    t.zoom && (n = t.zoom),
                    e && (e.duration && (0 == e.duration ? i = !1 : o = duration),
                        e.zoom && this.options.calculate_zoom && (n = e.zoom)),
                    this.options.map_center_offset && (s = this._getMapCenterOffset(s, n)),
                    this._map.setView(s, n, {
                        pan: {
                            animate: i,
                            duration: o,
                            easeLinearity: .1
            ...
            _getMapCenterOffset(t, e) {
                var i;
                return i = this._map.project(t, e).subtract([this.options.map_center_offset.left, this.options.map_center_offset.top]),
                    this._map.unproject(i, e);
            }
            ...
            _refreshMap() {
                this._map && (this.timer && (clearTimeout(this.timer),
                    this.timer = null),
                    this._map.invalidateSize(),
                    this._markers[this.current_marker].data.type && "overview" == this._markers[this.current_marker].data.type ? this._markerOverview() : this._viewTo(this._markers[this.current_marker].data.location, {
        ...
        T(ot, H),
            L.Map.include({
                _tryAnimatedPan: function(t, e) {
                    var i = this._getCenterOffset(t)._floor();
                    return this.panBy(i, e),
                        !0;
                },
                _tryAnimatedZoom: function(t, e, i) {
                    if(void 0 === this._animateZoom)
                        return !1;
                    if(this._animatingZoom)
                        return !0;
                    i = i || {};
                    var o = this.getZoomScale(e)
                        , n = this._getCenterOffset(t)._divideBy(1 - 1 / o)
                        , s = this._getCenterLayerPoint()._add(n);
                    return this.fire("movestart").fire("zoomstart"),
                        this._animateZoom(t, e, s, o, null, !0),
                        !0;
                },
                getBoundsZoom: function(t, e, i) {
                    t = L.latLngBounds(t);
                    var o, n = this.getMinZoom() - (e ? 1 : 0), s = (this.getMinZoom(),
                        this.getMaxZoom()), a = this.getSize(), r = t.getNorthWest(), h = t.getSouthEast(), l = [], c = {
                            x: 0,
                            y: 0
                        }, d = {};
                    i = L.point(i || [0, 0]),
        ...
        class nt {
            constructor(t, e, i) {
                this._el = {
                    ...
                    VCO.Browser.touch && (this.dragevent = this.touchdrag),
                    this.data = {
                        sliding: !1,
                        direction: "none",
                        pagex: {
            ...
            _onDragStart(t) {
                VCO.Browser.touch ? t.originalEvent ? (this.data.pagex.start = t.originalEvent.touches[0].screenX,
            ...
            _onDragMove(t) {
                t.preventDefault(),
                    this.data.sliding = !0,
                    VCO.Browser.touch ? t.originalEvent ? (this.data.pagex.end = t.originalEvent.touches[0].screenX,
            ...
            _animateMomentum() {
                ...
                this.options.enable.y && ((this.options.constraint.top || this.options.constraint.bottom) && (t.y > this.options.constraint.bottom ? t.y = this.options.constraint.bottom : t.y < this.options.constraint.top && (t.y = this.options.constraint.top)),
                    ...
                    this.animator = VCO.Animate(this._el.move, e),
        ...
        var st = {
            addListener: function(t, e, i, o) {
                ...
                if(!t[s]) {
                    ...
                    if(x && "dblclick" === e && this.addDoubleTapListener)
                        this.addDoubleTapListener(t, a, n);
                    else if("addEventListener" in t)
                        if("mousewheel" === e)
                            t.addEventListener("DOMMouseScroll", a, !1),
                                t.addEventListener(e, a, !1);
                        else if("mouseenter" === e || "mouseleave" === e) {
                            var r = a
                                , h = "mouseenter" === e ? "mouseover" : "mouseout";
                            a = function(e) {
                                if(st._checkMouse(t, e))
                                    return r(e);
                            }
                                ,
            ...
            removeListener: function(t, e, i) {
                var o = S()
                    , n = "_vco_" + e + o
                    , s = t[n];
                s && (x && "dblclick" === e && this.removeDoubleTapListener ? this.removeDoubleTapListener(t, o) : "removeEventListener" in t ? "mousewheel" === e ? (t.removeEventListener("DOMMouseScroll", s, !1),
                    t.removeEventListener(e, s, !1)) : "mouseenter" === e || "mouseleave" === e ? t.removeEventListener("mouseenter" === e ? "mouseover" : "mouseout", s, !1) : t.removeEventListener(e, s, !1) : "detachEvent" in t && t.detachEvent("on" + e, s),
                    t[n] = null);
            },
            _checkMouse: function(t, e) {
            ...
            disableClickPropagation: function(t) {
                st.addListener(t, nt.START, st.stopPropagation),
                    st.addListener(t, "click", st.stopPropagation),
                    st.addListener(t, "dblclick", st.stopPropagation);
            },
            preventDefault: function(t) {
        ...
        class at {
            ...
            _onButtonCollapseMap(t) {
                this.collapsed ? (this.collapsed = !1,
                    ...
                    this._el.button_collapse_toggle.innerHTML = b ? "<span class='vco-icon-arrow-up'></span>" : j.buttons.collapse_toggle + "<span class='vco-icon-arrow-up'></span>") : (this.collapsed = !0,
                        this.hide(25),
                        this._el.button_overview.style.display = "none",
                        this.fire("collapse", {
                            y: 1
                        }),
                        this._el.button_collapse_toggle.innerHTML = b ? "<span class='vco-icon-arrow-down'></span>" : j.buttons.uncollapse_toggle + "<span class='vco-icon-arrow-down'></span>");
            }
            _initLayout() {
                this._el.button_overview = N.create("span", "vco-menubar-button", this._el.container),
                    st.addListener(this._el.button_overview, "click", this._onButtonOverview, this),
                    this._el.button_backtostart = N.create("span", "vco-menubar-button", this._el.container),
                    st.addListener(this._el.button_backtostart, "click", this._onButtonBackToStart, this),
                    this._el.button_collapse_toggle = N.create("span", "vco-menubar-button", this._el.container),
                    st.addListener(this._el.button_collapse_toggle, "click", this._onButtonCollapseMap, this),
                    this.options.map_as_image ? this._el.button_overview.innerHTML = j.buttons.overview : this._el.button_overview.innerHTML = j.buttons.map_overview,
                    b ? (this._el.button_backtostart.innerHTML = "<span class='vco-icon-goback'></span>",
                        this._el.button_collapse_toggle.innerHTML = "<span class='vco-icon-arrow-up'></span>",
                        this._el.container.setAttribute("ontouchstart", " ")) : (this._el.button_backtostart.innerHTML = j.buttons.backtostart + " <span class='vco-icon-goback'></span>",
                            this._el.button_collapse_toggle.innerHTML = j.buttons.collapse_toggle + "<span class='vco-icon-arrow-up'></span>"),
        ...
        const ht = function() {
            var t = document
                ...
                , g = function() {
                    var e, i = t.createElement("a").style, o = ["webkitTransform", "MozTransform", "OTransform", "msTransform", "Transform"];
            ...
            function x(t, e) {
                var i, o = {};
                return (i = t.match(d)) && (o.rotate = O(i[1], e ? e.rotate : null)),
                    (i = t.match(p)) && (o.scale = O(i[1], e ? e.scale : null)),
                    (i = t.match(_)) && (o.skewx = O(i[1], e ? e.skewx : null),
                        o.skewy = O(i[3], e ? e.skewy : null)),
                    (i = t.match(u)) && (o.translatex = O(i[1], e ? e.translatex : null),
                        o.translatey = O(i[3], e ? e.translatey : null)),
                    o;
            }
            function M(t) {
                var e = "";
            ...
            function k(t) {
                ...
                return (n ? (e = n[1],
                    i = n[2],
                    o = n[3],
                    "#" + (1 << 24 | e << 16 | i << 8 | o).toString(16).slice(1)) : t).replace(/#(\w)(\w)(\w)$/, "#$1$1$2$2$3$3");
            }
            function P(t) {
            ...
            function S(t, e, i, o, s, a) {
                ...
                var h, l = t || r, c = this, d = a - s, p = n(), _ = 0, u = 0;
                return h = function t(n) {
                    var r = n - p;
                    if(r > l || _)
                        return a = isFinite(a) ? a : 1,
                            _ ? u && e(a) : e(a),
                            L(t),
                            i && i.apply(c);
            ...
            function C(t, e) {
                var i, o, n = t.length, s = [];
                for(i = 0;i < n;++i)
                    s[i] = [t[i][0], t[i][1]];
                for(o = 1;o < n;++o)
                    for(i = 0;i < n - o;++i)
                        s[i][0] = (1 - e) * s[i][0] + e * s[parseInt(i + 1, 10)][0],
                            s[i][1] = (1 - e) * s[i][1] + e * s[parseInt(i + 1, 10)][1];
                return [s[0][0], s[0][1]];
            }
            function E(t, e, i, o, n, s, a) {
                if("transform" == n) {
                    for(var h in a = {},
                        i[s][n])
                        a[h] = h in o[s][n] ? Math.round(((o[s][n][h] - i[s][n][h]) * t + i[s][n][h]) * r) / r : i[s][n][h];
                    return a;
                }
                return "string" == typeof i[s][n] ? function(t, e, i) {
                    ...
                    for(o = 0;o < 6;o++)
                        s = Math.min(15, parseInt(e.charAt(o), 16)),
                            a = Math.min(15, parseInt(i.charAt(o), 16)),
                            n = (n = Math.floor((a - s) * t + s)) > 15 ? 15 : n < 0 ? 0 : n,
                            r[o] = n.toString(16);
                    return "#" + r.join("");
                }(t, i[s][n], o[s][n]) : (a = Math.round(((o[s][n] - i[s][n]) * t + i[s][n]) * r) / r,
                    n in m || (a += e[s][n] || "px"),
                    a);
            }
            ...
            function z(t, e) {
                var i, o, n, s = t ? s = isFinite(t.length) ? t : [t] : [], a = e.complete, r = e.duration, l = e.easing, d = e.bezier, p = [], _ = [], u = [], m = [];
                for(d && (o = e.left,
                    n = e.top,
                    delete e.right,
                    delete e.bottom,
                    ...
                    if(p[i] = {},
                        ...
                        m[i] = T(d) ? d(s[i], b) : d,
                            m[i].push(b),
                            m[i].unshift([parseInt(y, 10), parseInt(w, 10)]);
                    }
                    for(var L in e) {
                        switch(L) {
                            case "complete":
                        ...
                        var D, z = v(s[i], L), B = T(e[L]) ? e[L](s[i]) : e[L];
                        "string" != typeof B || !h.test(B) || h.test(z) ? (p[i][L] = "transform" == L ? x(z) : "string" == typeof B && h.test(B) ? k(z).slice(1) : parseFloat(z),
                            _[i][L] = "transform" == L ? x(B, p[i][L]) : "string" == typeof B && "#" == B.charAt(0) ? k(B).slice(1) : O(B, parseFloat(z)),
                            "string" == typeof B && (D = B.match(c)) && (u[i][L] = D[1])) : delete e[L];
                    }
                }
                return S.apply(s, [r, function(t, o, n) {
                    for(i = s.length;i--;)
                        for(var a in d && (n = C(m[i], t),
                            s[i].style.left = n[0] + "px",
                            s[i].style.top = n[1] + "px"),
                            e)
                            o = E(t, u, p, _, a, i),
                                "transform" == a ? s[i].style[g] = M(o) : "opacity" != a || f ? s[i].style[P(a)] = o : s[i].style.filter = "alpha(opacity=" + 100 * o + ")";
                }
                    , a, l]);
            }
            return y((function(t) {
        ...
        class lt {
            constructor(t, e, i) {
                this._el = {
                    ...
                    D(this.options, e),
                    D(this.data, t),
                    this._el.container = N.create("div", "vco-slidenav-" + this.options.direction),
                    b && this._el.container.setAttribute("ontouchstart", " "),
                    this._initLayout(),
                    this._initEvents(),
            ...
            updatePosition(t, e, i, o, n, s) {
                ...
                for(var c in t)
                    t.hasOwnProperty(c) && (h[c] = e ? t[c] + "%" : t[c] + "px");
                this.animator_position && this.animator_position.stop(),
                    a = h.right ? "right" : "left",
                    this._el.container.style[a] = e ? l + "%" : l + "px",
                    this.animator_position = rt(this._el.container, h);
            }
            _onUpdatePositionComplete(t) {
                t && (this._el.container.style.left = "",
            ...
            _update(t) {
                this.data = D(this.data, t),
                    "" != this.data.title && (this._el.title.innerHTML = this.data.title),
                    "" != this.data.date && (this._el.description.innerHTML = this.data.description);
            }
            _initLayout() {
                this._el.content_container = N.create("div", "vco-slidenav-content-container", this._el.container),
                    this._el.icon = N.create("div", "vco-slidenav-icon", this._el.content_container),
                    this._el.title = N.create("div", "vco-slidenav-title", this._el.content_container),
                    this._el.description = N.create("div", "vco-slidenav-description", this._el.content_container),
        ...
        class ct {
            constructor(t, e, i) {
                this._el = {
                    ...
                    D(this.data, t),
                    D(this.options, e),
                    this._el.container = N.create("div", this.options.message_class),
                    i && (i.appendChild(this._el.container),
                        this._el.parent = i),
                    this.animator = {},
                    this._initLayout(),
            ...
            _updateMessage(t) {
                this._el.message.innerHTML = t || (j ? j.messages.loading : "Loading");
            }
            _onMouseClick() {
                this.fire("clicked", this.options);
            }
            _initLayout() {
                this._el.message_container = N.create("div", "vco-message-container", this._el.container),
                    this._el.loading_icon = N.create("div", this.options.message_icon_class, this._el.message_container),
                    this._el.message = N.create("div", "vco-message-content", this._el.message_container),
                    this._updateMessage();
            }
            _initEvents() {
                st.addListener(this._el.container, "click", this._onMouseClick, this);
        ...
        class dt {
            constructor(t, e, i) {
                this._el = {
                    ...
                    D(this.options, e),
                    D(this.data, t),
                    this._el.container = N.create("div", "vco-media"),
                    this.data.uniqueid && (this._el.container.id = this.data.uniqueid),
                    this._initLayout(),
                    i && (i.appendChild(this._el.container),
                        this._el.parent = i);
            }
            ...
            updateMediaDisplay(t) {
                this._state.loaded && (this._updateMediaDisplay(t),
                    b || "portrait" == t || (this._el.content_item.style.maxHeight = this.options.height / 2 + "px"),
                    this._state.media_loaded && (this._el.credit && (this._el.credit.style.width = "auto"),
                        this._el.caption && (this._el.caption.style.width = "auto")),
                    w && (this._el.content_item.offsetWidth > this._el.content_item.offsetHeight && (this._el.content_item.style.width = "100%",
                        this._el.content_item.style.maxWidth = "100%"),
                        "portrait" == t && (this._el.content_item.style.maxHeight = "none")),
            ...
            loadErrorDisplay(t) {
                this._el.content.removeChild(this._el.content_item),
                    this._el.content_item = N.create("div", "vco-media-item vco-media-loaderror", this._el.content),
                    this._el.content_item.innerHTML = "<div class='vco-icon-" + this.options.media_type + "'></div><p>" + t + "</p>",
                    this.onLoaded(!0);
            }
            onLoaded(t) {
            ...
            showMeta(t, e) {
                this._state.show_meta = !0,
                    this.data.credit && "" != this.data.credit && !this._el.credit && (this._el.credit = N.create("div", "vco-credit", this._el.content_container),
                        this._el.credit.innerHTML = this.data.credit,
                        this.options.credit_height = this._el.credit.offsetHeight),
                    this.data.caption && "" != this.data.caption && !this._el.caption && (this._el.caption = N.create("div", "vco-caption", this._el.content_container),
            ...
            _initLayout() {
                this.message = new ct({}, this.options),
                    this.message.addTo(this._el.container),
                    this._el.content_container = N.create("div", "vco-media-content-container", this._el.container),
                    this.data.link && "" != this.data.link ? (this._el.link = N.create("a", "vco-media-link", this._el.content_container),
                        this._el.link.href = this.data.link,
                        this.data.link_target && "" != this.data.link_target ? this._el.link.target = this.data.link_target : this._el.link.target = "_blank",
                        this._el.content = N.create("div", "vco-media-content", this._el.link)) : this._el.content = N.create("div", "vco-media-content", this._el.content_container);
            }
            _updateDisplay(t, e, i) {
                t && (this.options.width = t),
                    e && (this.options.height = e),
        ...
        class pt extends dt {
            _loadMedia() {
                ...
                this.message.updateMessage(j.messages.loading + " " + this.options.media_name),
                    this.data.link ? (this._el.content_link = N.create("a", "", this._el.content),
                        this._el.content_link.href = this.data.link,
                        this._el.content_link.target = "_blank",
                        this._el.content_item = N.create("img", "vco-media-item vco-media-image vco-media-shadow", this._el.content_link)) : this._el.content_item = N.create("img", "vco-media-item vco-media-image vco-media-shadow", this._el.content),
        ...
        class _t extends dt {
            _loadMedia() {
                ...
                this.message.updateMessage(j.messages.loading + " " + this.options.media_name),
                    ...
                    this._el.content_item = N.create("div", "vco-media-item vco-media-youtube vco-media-shadow", this._el.content),
                    this._el.content_item.id = C(7),
                    t = function(t) {
                        var e, i, o, n = [];
                        (e = t.toString()).match("&#038;") ? e = e.replace("&#038;", "&") : e.match("&#38;") ? e = e.replace("&#38;", "&") : e.match("&amp;") && (e = e.replace("&amp;", "&")),
                            o = e.slice(e.indexOf("?") + 1).split("&");
                    ...
                    this.media_id = {},
                    this.data.url.match("v=") ? this.media_id.id = t.v : this.data.url.match("/embed/") ? this.media_id.id = this.data.url.split("embed/")[1].split(/[?&]/)[0] : this.data.url.match(/v\/|v=|youtu\.be\//) ? this.media_id.id = this.data.url.split(/v\/|v=|youtu\.be\//)[1].split(/[?&]/)[0] : console.log("YouTube in URL but not a valid video"),
                    this.media_id.start = t.t,
                    this.media_id.hd = t.hd,
                    B("https://www.youtube.com/iframe_api", (function() {
                        e.createMedia();
                    }
                    ));
            }
            _updateMediaDisplay() {
                this._el.content_item.style.height = z({
            ...
            createMedia() {
                if(void 0 !== this.media_id.start) {
                    var t = this.media_id.start.toString()
                        , e = 0
                        , i = 0;
                    t.match("m") ? (e = parseInt(t.split("m")[0], 10),
                        i = parseInt(t.split("m")[1].split("s")[0], 10),
                        this.media_id.start = 60 * e + i) : this.media_id.start = 0;
                } else
                    this.media_id.start = 0;
                void 0 !== this.media_id.hd ? this.media_id.hd = !0 : this.media_id.hd = !1,
                    this.createPlayer();
            }
            createPlayer() {
                var t = this;
                clearTimeout(this.timer),
                    "undefined" != typeof YT && void 0 !== YT.Player ? this.player = new YT.Player(this._el.content_item.id, {
                        playerVars: {
                            enablejsapi: 1,
                            color: "white",
                            autohide: 1,
            ...
            onStateChange(t) {
                t.data == YT.PlayerState.ENDED && (t.target.seekTo(0),
                    t.target.pauseVideo());
            }
        }
        class ut extends dt {
            _loadMedia() {
                this.message.updateMessage(j.messages.loading + " " + this.options.media_name),
                    this._el.content_item = N.create("div", "vco-media-item vco-media-blockquote", this._el.content),
        ...
        class mt extends dt {
            _loadMedia() {
                var t, e, i = this;
                this.message.updateMessage(j.messages.loading + " " + this.options.media_name),
                    this._el.content_item = N.create("div", "vco-media-item vco-media-wikipedia", this._el.content),
                    this.media_id = this.data.url.split("wiki/")[1].split("#")[0].replace("_", " "),
                    this.media_id = this.media_id.replace(" ", "%20"),
                    e = this.data.url.split("//")[1].split(".wikipedia")[0];
                let o = "wikipediaCallback_"
                    , n = o + this.media_id.replace(/[^0-9a-z]/gi, "").slice(0, 494);
                t = `https://${e}.wikipedia.org/w/api.php?action=query&prop=extracts&redirects=&titles=${this.media_id}&exintro=1&format=json&callback=${n}`;
            ...
            createMedia(t) {
                ...
                if(t.query) {
                    ...
                    for(var o = 0;o < e.text_array.length;o++)
                        o + 1 <= e.paragraphs && o + 1 < e.text_array.length && (e.text += "<p>" + e.text_array[o + 1]);
                    i = "<h4><a href='" + this.data.url + "' target='_blank'>" + e.title + "</a></h4>",
                        i += "<span class='wiki-source'>" + j.messages.wikipedia + "</span>",
                        i += e.text,
                        e.extract.match("REDIRECT") || (this._el.content_item.innerHTML = i,
                            this.onLoaded());
                }
            }
            updateMediaDisplay() {}
        ...
        class gt extends dt {
            _loadMedia() {
                var t, e = this;
                this.message.updateMessage(j.messages.loading + " " + this.options.media_name),
                    this._el.content_item = N.create("div", "vco-media-item vco-media-iframe vco-media-soundcloud vco-media-shadow", this._el.content),
                    this.media_id = this.data.url,
                    t = "https://soundcloud.com/oembed?url=" + this.media_id + "&format=json",
                    fetch(t).then((t => t.json().then((t => {
                        B("https://w.soundcloud.com/player/api.js", (function() {
                            e.createMedia(t);
                        }
                        ));
                    }
        ...
        class ft extends dt {
            _loadMedia() {
                var t;
                this.message.updateMessage(j.messages.loading + " " + this.options.media_name),
                    this._el.content_item = N.create("div", "vco-media-item vco-media-iframe vco-media-vimeo vco-media-shadow", this._el.content),
                    this.media_id = this.data.url.split(/video\/|\/\/vimeo\.com\//)[1].split(/[?&]/)[0],
                    t = "https://player.vimeo.com/video/" + this.media_id + "?api=1&title=0&amp;byline=0&amp;portrait=0&amp;color=ffffff",
                    this.player = N.create("iframe", "", this._el.content_item),
        ...
        class vt extends dt {
            _loadMedia() {
                var t;
                this.message.updateMessage(j.messages.loading + " " + this.options.media_name),
                    this._el.content_item = N.create("div", "vco-media-item vco-media-iframe vco-media-dailymotion", this._el.content),
        ...
        class yt extends dt {
            _loadMedia() {
                var t;
                this.message.updateMessage(j.messages.loading + " " + this.options.media_name),
                    this._el.content_item = N.create("div", "vco-media-item vco-media-iframe vco-media-vine vco-media-shadow", this._el.content),
        ...
        class wt extends dt {
            _loadMedia() {
                var t, e = this;
                this.message.updateMessage(j.messages.loading + " " + this.options.media_name),
                    this._el.content_item = N.create("div", "vco-media-twitter", this._el.content);
            ...
            createMedia(t) {
                var e, i, o, n = "", s = "", a = "";
                s = t.html.split("</p>&mdash;")[0] + "</p></blockquote>",
                    e = t.author_url.split("twitter.com/")[1],
                    i = (a = t.html.split("</p>&mdash;")[1].split('<a href="')[1]).split('">')[0],
                    o = a.split('">')[1].split("</a>")[0],
                    n += s = s.replace(/<a href/gi, '<a target="_blank" href'),
                    n += "<div class='vcard'>",
                    n += "<a href='" + i + "' class='twitter-date' target='_blank'>" + o + "</a>",
                    n += "<div class='author'>",
                    n += "<a class='screen-name url' href='" + t.author_url + "' target='_blank'>",
                    n += "<span class='avatar'></span>",
                    n += "<span class='fn'>" + t.author_name + " <span class='vco-icon-twitter'></span></span>",
                    n += "<span class='nickname'>@" + e + "<span class='thumbnail-inline'></span></span>",
                    n += "</a>",
                    n += "</div>",
                    n += "</div>",
                    this._el.content_item.innerHTML = n,
                    this.onLoaded();
            }
            updateMediaDisplay() {}
            _updateMediaDisplay() {}
        ...
        class bt extends dt {
            _loadMedia() {
                var t, e = this;
                this.message.updateMessage(j.messages.loading + " " + this.options.media_name),
                    this._el.content_item = N.create("img", "vco-media-item vco-media-image vco-media-flickr vco-media-shadow", this._el.content),
                    this._el.content_item.addEventListener("load", (function(t) {
                        e.onMediaLoaded();
                    }
                    )),
                    this.establishMediaID(),
                    t = "https://api.flickr.com/services/rest/?method=flickr.photos.getSizes&api_key=" + this.options.api_key_flickr + "&photo_id=" + this.media_id + "&format=json&nojsoncallback=1",
                    fetch(t).then((t => t.json().then((t => {
            ...
            createMedia(t) {
                for(var e = this.sizes(this.options.height), i = t.sizes.size[t.sizes.size.length - 2].source, o = 0;o < t.sizes.size.length;o++)
                    t.sizes.size[o].label == e && (i = t.sizes.size[o].source);
                this._el.content_item.src = i,
                    this.onLoaded();
            }
            sizes(t) {
        ...
        class Lt extends dt {
            _loadMedia() {
                this.message.updateMessage(j.messages.loading + " " + this.options.media_name),
                    this._el.content_item = N.create("div", "vco-media-item vco-media-iframe", this._el.content),
                    this.media_id = this.data.url,
                    this.media_id,
                    this.media_id.match(/docs.google.com/i) ? this._el.content_item.innerHTML = "<iframe class='doc' frameborder='0' width='100%' height='100%' src='" + this.media_id + "&amp;embedded=true'></iframe>" : this._el.content_item.innerHTML = "<iframe class='doc' frameborder='0' width='100%' height='100%' src='http://docs.google.com/viewer?url=" + this.media_id + "&amp;embedded=true'></iframe>",
                    this.onLoaded();
            }
            _updateMediaDisplay() {
        ...
        class xt extends dt {
            _loadMedia() {
                this._el.content_item = N.create("img", "vco-media-item vco-media-image", this._el.content),
                    this._el.content_item.src = this.data.url,
                    this.onLoaded();
            }
        }
        ...
        function Pt(t) {
            for(var e = {}, i = [{
                ...
                if(t.url.match(i[o].match_str))
                    return (e = i[o]).url = t.url,
                        e;
            }
            return !1;
        }
        class Tt {
            constructor(t, e, i) {
                this._el = {
                    ...
                    function(t, e) {
                        t.data = P({}, t.data, e),
                            "" === t.data.uniqueid && (t.data.uniqueid = C(6));
                    }(this, t),
                    D(this.options, e),
                    this._el.container = N.create("div", "vco-text"),
            ...
            _initLayout() {
                if(this._el.content_container = N.create("div", "vco-text-content-container", this._el.container),
                    this._el.date = N.create("h3", "vco-headline-date", this._el.content_container),
                    "" != this.data.headline) {
                    var t = "vco-headline";
                    this.options.title && (t = "vco-headline vco-headline-title"),
                        this._el.headline = N.create("h2", t, this._el.content_container),
                        this._el.headline.innerHTML = this.data.headline;
                }
                if("" != this.data.text) {
                    var e = "";
                    e += E(this.data.text),
                        this.data.date && this.data.date.created_time && "" != this.data.date.created_time && this.data.date.created_time.length > 10 && ("undefined" != typeof moment ? e += "<div class='vco-text-date'>" + moment(this.data.date.created_time, "YYYY-MM-DD h:mm:ss").fromNow() + "</div>" : e += "<div class='vco-text-date'>" + function(t) {
                            var e = /^(\d{4})-(\d{2})-(\d{2})[T\s](\d{2}):(\d{2}):(\d{2})/;
                            if(t.match(e))
                                var i = t.match(e).slice(1);
                            for(var o = [], n = 0;n < i.length;n++) {
                                var s = parseInt(i[n]);
                                1 == n && (s -= 1),
                                    o.push(s);
                            }
                            return date = new Date(o[0], o[1], o[2], o[3], o[4], o[5]),
                                ...
                                time = month + ", " + day + " " + year,
                                time;
                        }(this.data.date.created_time) + "</div>"),
                        this._el.content = N.create("div", "vco-text-content", this._el.content_container),
        ...
        class Dt {
            ...
            stopMedia() {
                if(this._media && this._state.loaded)
                    try {
                        ...
                        if("this._el.content_item.querySelector is not a function" != t.message)
                            throw t;
            ...
            addCallToAction(t) {
                this._el.call_to_action = N.create("div", "vco-slide-calltoaction", this._el.content_container),
                    this._el.call_to_action.innerHTML = "<span class='vco-slide-calltoaction-button-text'>" + t + "</span>",
                    st.addListener(this._el.call_to_action, "click", this._onCallToAction, this);
            }
            _onCallToAction(t) {
            ...
            _initLayout() {
                this._el.container = N.create("div", "vco-slide"),
                    this.data.uniqueid && (this._el.container.id = this.data.uniqueid),
                    this._el.scroll_container = N.create("div", "vco-slide-scrollable-container", this._el.container),
                    this._el.content_container = N.create("div", "vco-slide-content-container", this._el.scroll_container),
                    this._el.content = N.create("div", "vco-slide-content", this._el.content_container),
                    this._el.background = N.create("div", "vco-slide-background", this._el.container),
                    this.data.background && (this.data.background.url && (this.has.background.image = !0,
                        ...
                        this.data.background.text_background && (this._el.container.className += " vco-text-background")),
                    ...
                    this.has.media && (this.data.media.mediatype = Pt(this.data.media),
                        this.options.media_name = this.data.media.mediatype.name,
                        this.options.media_type = this.data.media.mediatype.type,
                        this._media = new this.data.media.mediatype.cls(this.data.media, this.options)),
                    (this.has.text || this.has.headline) && (this._text = new Tt(this.data.text, {
                        title: this.has.title
                    })),
                    this.has.text || this.has.headline || !this.has.media ? this.has.headline && this.has.media && !this.has.text ? (this._el.container.className += " vco-slide-media-only",
                        this._text.addTo(this._el.content),
                        this._media.addTo(this._el.content)) : this.has.text && this.has.media ? (this._media.addTo(this._el.content),
                            this._text.addTo(this._el.content)) : (this.has.text || this.has.headline) && (this._el.container.className += " vco-slide-text-only",
                                this._text.addTo(this._el.content)) : (this._el.container.className += " vco-slide-media-only",
            ...
            _updateDisplay(t, e, i) {
                ...
                this.options.width = t || this._el.container.offsetWidth,
                    b && this.options.width <= this.options.skinny_size ? (o = "0px",
                        n = "0px",
                        s = this.options.width - 0 + "px") : "landscape" == i ? (o = "40px",
                            n = "75px",
                            s = this.options.width - 115 + "px") : (this.options.width,
                                this.options.skinny_size,
                                o = this.options.slide_padding_lr + "px",
                                n = this.options.slide_padding_lr + "px",
                                s = this.options.width - 2 * this.options.slide_padding_lr + "px"),
                    this._el.content.style.paddingLeft = o,
                    this._el.content.style.paddingRight = n,
                    this._el.content.style.width = s,
                    this._el.call_to_action && (this._el.call_to_action.style.paddingLeft = o,
                        this._el.call_to_action.style.paddingRight = n,
                        this._el.call_to_action.style.width = s),
                    this.options.height = e || this._el.container.offsetHeight,
                    this._media && (!this.has.text && this.has.headline ? this._media.updateDisplay(this.options.width, this.options.height - this._text.headlineHeight(), i) : this._media.updateDisplay(this.options.width, this.options.height, i));
            }
        }
        T(Dt, H, F);
        class St {
            ...
            enable(t) {
                st.addListener(this._el.drag, this.dragevent.down, this._onDragStart, this),
                    st.addListener(this._el.drag, this.dragevent.up, this._onDragEnd, this),
                    this.data.pos.start = 0,
                    this._el.move.style.left = this.data.pos.start.x + "px",
                    this._el.move.style.top = this.data.pos.start.y + "px",
                    this._el.move.style.position = "absolute";
            ...
            disable() {
                st.removeListener(this._el.drag, this.dragevent.down, this._onDragStart, this),
                    st.removeListener(this._el.drag, this.dragevent.up, this._onDragEnd, this);
            }
            stopMomentum() {
                this.animator && this.animator.stop();
            }
            ...
            _onDragStart(t) {
                this.animator && this.animator.stop(),
                    x ? t.originalEvent ? (this.data.pagex.start = t.originalEvent.touches[0].screenX,
                        this.data.pagey.start = t.originalEvent.touches[0].screenY) : (this.data.pagex.start = t.targetTouches[0].screenX,
                            this.data.pagey.start = t.targetTouches[0].screenY) : (this.data.pagex.start = t.pageX,
                                this.data.pagey.start = t.pageY),
                    ...
                    this.data.time.start = (new Date).getTime(),
                    this.fire("dragstart", this.data),
                    st.addListener(this._el.drag, this.dragevent.move, this._onDragMove, this),
                    st.addListener(this._el.drag, this.dragevent.leave, this._onDragEnd, this);
            }
            _onDragEnd(t) {
                this.data.sliding = !1,
                    st.removeListener(this._el.drag, this.dragevent.move, this._onDragMove, this),
                    st.removeListener(this._el.drag, this.dragevent.leave, this._onDragEnd, this),
                    this.fire("dragend", this.data),
                    this._momentum();
            }
            _onDragMove(t) {
                ...
                this.data.sliding = !0,
                    x ? t.originalEvent ? (this.data.pagex.end = t.originalEvent.touches[0].screenX,
                        this.data.pagey.end = t.originalEvent.touches[0].screenY) : (this.data.pagex.end = t.targetTouches[0].screenX,
                            this.data.pagey.end = t.targetTouches[0].screenY) : (this.data.pagex.end = t.pageX,
                                this.data.pagey.end = t.pageY),
            ...
            _momentum() {
                ...
                this.data.direction = null,
                    ...
                    i.x && (Math.abs(e.x) > this._el.drag.offsetWidth / 2 && (o = !0),
                        Math.abs(e.x) > 1e4 && (this.data.direction = "left",
                            e.x > 0 && (this.data.direction = "right"))),
                    i.y && (Math.abs(e.y) > this._el.drag.offsetHeight / 2 && (o = !0),
                        Math.abs(e.y) > 1e4 && (this.data.direction = "up",
                            e.y > 0 && (this.data.direction = "down"))),
                    this._animateMomentum(),
                    o && this.data.direction ? this.fire("swipe_" + this.data.direction, this.data) : this.data.direction ? this.fire("swipe_nodirection", this.data) : this.options.snap && (this.animator.stop(),
                        this.animator = rt(this._el.move, {
                            top: this.data.pos.start.y,
                            left: this.data.pos.start.x,
                            duration: this.options.duration,
                            easing: Z.easeOutStrong
                        }));
            }
            _animateMomentum() {
                var t = {
                ...
                this.options.enable.y && ((this.options.constraint.top || this.options.constraint.bottom) && (t.y > this.options.constraint.bottom ? t.y = this.options.constraint.bottom : t.y < this.options.constraint.top && (t.y = this.options.constraint.top)),
                    ...
                    this.options.enable.x && ((this.options.constraint.left || this.options.constraint.right) && (t.x >= this.options.constraint.left ? t.x = this.options.constraint.left : t.x < this.options.constraint.right && (t.x = this.options.constraint.right)),
                        e.left = Math.floor(t.x) + "px"),
                    this.animator = rt(this._el.move, e),
                    this.fire("momentum", this.data);
            }
        }
        T(St, H);
        class Ct {
            constructor(t, e, i, o) {
                this._el = {
                    ...
                    "object" == typeof t ? (this._el.container = t,
                        this.options.id = C(6, "vco")) : (this.options.id = t,
                            this._el.container = N.get(t)),
            ...
            _createSlides(t) {
                for(var e = 0;e < t.length;e++)
                    "" == t[e].uniqueid && (t[e].uniqueid = C(6, "vco-slide")),
                        0 == e ? this._createSlide(t[e], !0) : this._createSlide(t[e], !1);
            }
            _createSlide(t, e) {
            ...
            _destroySlide(t) {
                this._removeSlide(t);
                for(var e = 0;e < this._slides.length;e++)
                    this._slides[e] == t && this._slides.splice(e, 1);
            }
            _addSlide(t) {
            ...
            _removeSlide(t) {
                t.removeFrom(this._el.slider_item_container),
                    t.off("added", this._onSlideAdded, this),
            ...
            goTo(t, e, i) {
                ...
                for(var n = 0;n < this._slides.length;n++)
                    this._slides[n].setActive(!1);
                t < this._slides.length && t >= 0 && (this.current_slide = t,
                    this.animator && this.animator.stop(),
                    this._swipable && this._swipable.stopMomentum(),
                    e ? (this._el.slider_container.style.left = -this.slide_spacing * t + "px",
                        this._onSlideChange(i)) : this.animator = rt(this._el.slider_container, {
                            left: -this.slide_spacing * t + "px",
                            duration: this.options.duration,
                            easing: this.options.ease,
                            complete: this._onSlideChange(i)
                        }),
                    this._slides[this.current_slide].setActive(!0),
                    this._slides[this.current_slide + 1] ? (this.showNav(this._nav.next, !0),
                        this._nav.next.update(this.getNavInfo(this._slides[this.current_slide + 1]))) : this.showNav(this._nav.next, !1),
                    this._slides[this.current_slide - 1] ? (this.showNav(this._nav.previous, !0),
                        this._nav.previous.update(this.getNavInfo(this._slides[this.current_slide - 1]))) : this.showNav(this._nav.previous, !1),
            ...
            preloadSlides() {
                this._slides[this.current_slide + 1] && (this._slides[this.current_slide + 1].loadMedia(),
                    this._slides[this.current_slide + 1].scrollToTop()),
                    this._slides[this.current_slide + 2] && (this._slides[this.current_slide + 2].loadMedia(),
            ...
            getNavInfo(t) {
                ...
                return t.data.text && t.data.text.headline && (e.title = t.data.text.headline),
                    e;
            }
            next() {
            ...
            changeBackground(t) {
                var e, i = this, o = !1, n = {
                    ...
                    g: 256,
                    b: 256
                }, s = this.options.slide_default_fade, a = "0.87", r = "";
                ...
                n = t.color_value ? function(t) {
                    ...
                    this.animator_background && this.animator_background.stop(),
                    e = n.r + "," + n.g + "," + n.b,
                    this.current_bg_color && this.current_bg_color == e || (this.current_bg_color = e,
                        o = !0),
                    o && ("landscape" == this.options.layout ? (this._nav.next.setColor(!1),
                        this._nav.previous.setColor(!1),
                        n.r < 255 && n.g < 255 && n.b < 255 && (s = "15%"),
                        t.image && (s = "0%"),
                        r += "opacity:0;",
                        r += "background-image: -webkit-linear-gradient(left, color-stop(rgba(" + e + ",0.0001 ) " + s + "), color-stop(rgba(" + e + "," + a + ") 15%));",
                        r += "background-image: linear-gradient(to right, rgba(" + e + ",0.0001 ) " + s + ", rgba(" + e + "," + a + ") 15%);",
                        r += "background-repeat: repeat-x;",
                        r += "filter: e(%('progid:DXImageTransform.Microsoft.gradient(startColorstr='%d', endColorstr='%d', GradientType=1)',argb(" + e + ", 0.0001),argb(" + e + ",0.80)));") : (t.color_value ? r += "background-color:" + t.color_value + ";" : r += "background-color:#FFF;",
                            n.r < 255 && n.g < 255 && n.b < 255 || t.image ? (this._nav.next.setColor(!0),
                                this._nav.previous.setColor(!0)) : (this._nav.next.setColor(!1),
                                    this._nav.previous.setColor(!1))),
                        this.animator_background = rt(this._el.background, {
                            opacity: 0,
                            duration: this.options.duration / 2,
                            easing: this.options.ease,
                            complete: function() {
                                i.fadeInBackground(r);
                            }
                        }));
            }
            fadeInBackground(t) {
                this.animator_background && this.animator_background.stop(),
                    t && this._el.background.setAttribute("style", t),
                    this.animator_background = rt(this._el.background, {
                        opacity: 1,
                        duration: this.options.duration / 2,
                        easing: this.options.ease
            ...
            _updateDisplay(t, e, i, o) {
                var n, s;
                s = void 0 === o ? this.options.layout : o,
                    this.options.layout = s,
                    this.slide_spacing = 2 * this.options.width,
                    this.options.width = t || this._el.container.offsetWidth,
                    this.options.height = e || this._el.container.offsetHeight,
                    n = this.options.height / 2,
                ...
                for(var a = 0;a < this._slides.length;a++)
                    this._slides[a].updateDisplay(this.options.width, this.options.height, s),
                        this._slides[a].setPosition({
            ...
            _introInterface() {
                if(this.options.call_to_action) {
                    var t = j.messages.start;
                    "" != this.options.call_to_action_text && (t = this.options.call_to_action_text),
                        this._slides[0].addCallToAction(t),
                        this._slides[0].on("call_to_action", this.next, this);
                }
                this.options.width <= this.options.skinny_size || (this._nav.next.updatePosition({
                    right: "130"
                }, !1, 3 * this.options.duration, this.options.ease, -100, !0),
            ...
            _initLayout() {
                this._el.container.className += " vco-storyslider",
                    this._el.slider_container_mask = N.create("div", "vco-slider-container-mask", this._el.container),
                    this._el.background = N.create("div", "vco-slider-background", this._el.container),
                    this._el.slider_container = N.create("div", "vco-slider-container vcoanimate", this._el.slider_container_mask),
                    this._el.slider_item_container = N.create("div", "vco-slider-item-container", this._el.slider_container),
                    this.options.width = this._el.container.offsetWidth,
                    this.options.height = this._el.container.offsetHeight,
                    this._nav.previous = new lt({
                        title: "Previous",
                        description: "description"
                    }, {
                        direction: "previous"
                    ...
                    x && (this._swipable = new St(this._el.slider_container_mask, this._el.slider_container, {
                        enable: {
                            x: !0,
                            y: !1
                        },
                        ...
                        this._message = new ct({}, {
                            message_class: "vco-message-full",
                            message_icon_class: "vco-icon-swipe-left"
                        }),
                        this._message.updateMessage(j.buttons.swipe_to_navigate),
            ...
            _fireMouseEvent(t) {
                if(this._loaded) {
                    ...
                    e = "mouseenter" === e ? "mouseover" : "mouseleave" === e ? "mouseout" : e,
                        this.hasEventListeners(e) && ("contextmenu" === e && st.preventDefault(t),
                            this.fire(e, {
                                latlng: "something",
        ...
        class Et {
            constructor(t, e, i, o) {
                for(let t in o) {
                    ...
                    if("function" == typeof n)
                        ...
                        for(var s in n)
                            "function" == typeof n[s] ? this.on(t, n[s]) : console.log("WARNING: Ignoring invalid callback '" + n[s] + "' defined for listener '" + t + "' in StoryMap constructor");
                }
                return this.version = "0.1.16",
                    this.ready = !1,
                    this._el = {
                        container: {},
                        storyslider: {},
            ...
            _initData(t) {
                ...
                )) : "object" == typeof t ? (t.storymap ? e.data = t.storymap : console.log("data must have a storymap property"),
                    e._initOptions()) : (console.log("data has unknown type"),
                        e._initOptions());
            }
            _initOptions() {
                var t = this;
                !function(t, e) {
                    ...
                    "landscape" == this.options.layout && (this.options.map_center_offset = {
                        left: -200,
                        top: 0
                    }),
                    "zoomify" == this.options.map_type && this.options.map_as_image && (this.options.map_size_sticky = 2),
                    this.options.map_as_image && (this.options.calculate_zoom = !1),
                    this.options.relative_date ? "undefined" != typeof moment ? t._loadLanguage() : B(this.options.script_path + "/library/moment.js", (function() {
                        t._loadLanguage();
                    }
                    )) : t._loadLanguage(),
                    y && A(function(t, e) {
                        t.length && "/" == t[t.length - 1] && (t = t.substring(0, t.length - 1)),
                            e.length && "/" == e[0] && (e = e.substring(1));
            ...
            _loadLanguage() {
                W(this.options.language),
                    this._onDataLoaded();
            }
            goTo(t) {
                t != this.current_slide && (this.current_slide = t,
            ...
            _initLayout() {
                this._el.container.className += " vco-storymap",
                    ...
                    this._el.menubar = N.create("div", "vco-menubar", this._el.container),
                    this._el.map = N.create("div", "vco-map", this._el.container),
                    this._el.storyslider = N.create("div", "vco-storyslider", this._el.container),
                    this.options.width = this._el.container.offsetWidth,
                    this.options.height = this._el.container.offsetHeight,
                    this._el.map.style.height = "1px",
                    this._el.storyslider.style.top = "1px",
                    this._map = new ot(this._el.map, this.data, this.options),
                    ...
                    this._menubar = new at(this._el.menubar, this._el.container, this.options),
                    this._storyslider = new Ct(this._el.storyslider, this.data, this.options),
                    this._storyslider.on("loaded", this._onStorySliderLoaded, this),
                    this._storyslider.on("title", this._onTitle, this),
                    this._storyslider.init(),
                    "portrait" == this.options.layout ? (this.options.map_height = this.options.height / this.options.map_size_sticky,
                        this.options.storyslider_height = this.options.height - this._el.menubar.offsetHeight - this.options.map_height - 1,
                        this._menubar.setSticky(0)) : (this.options.menubar_height = this._el.menubar.offsetHeight,
                    ...
                    this._updateDisplay(this.options.map_height, !0, 2e3),
            ...
            _updateDisplay(t, e, i) {
                ...
                i && (o = i),
                    this.options.width = this._el.container.offsetWidth,
                    this.options.height = this._el.container.offsetHeight,
                    this.options.width <= this.options.skinny_size ? this.options.layout = "portrait" : this.options.layout = "landscape",
                    t && (this.options.map_height = t),
                    x && (this.options.layout = k(),
                        n += " vco-mobile"),
                    "portrait" == this.options.layout ? (n += " vco-skinny",
                        ...
                        n += " vco-layout-portrait",
                        e ? (this.animator_map && this.animator_map.stop(),
                            this.animator_map = rt(this._el.map, {
                            ...
                            this.animator_storyslider = rt(this._el.storyslider, {
                                height: this.options.storyslider_height + "px",
                                duration: o,
                                easing: Z.easeOutStrong
                            })) : (this._el.map.style.height = Math.ceil(this.options.map_height) + "px",
                                this._el.storyslider.style.height = this.options.storyslider_height + "px"),
                        this._menubar.updateDisplay(this.options.width, this.options.height, e),
                        this._map.updateDisplay(this.options.width, this.options.height, !1),
                        this._storyslider.updateDisplay(this.options.width, this.options.storyslider_height, e, this.options.layout)) : (n += " vco-layout-landscape",
                            ...
                            this._el.storyslider.style.height = this.options.storyslider_height + "px",
                            this._menubar.updateDisplay(this.options.width, this.options.height, e),
                            this._map.updateDisplay(this.options.width, this.options.height, e, i),
                            this._storyslider.updateDisplay(this.options.width / 2, this.options.storyslider_height, e, this.options.layout)),
                    ("rtl" == this.options.language.direction || "rtl" == this.options.language.direction) && (n += " vco-rtl"),
            ...
            _onSlideChange(t) {
                this.current_slide != t.current_slide && (this.current_slide = t.current_slide,
                    this._map.goTo(this.current_slide),
                    this.fire("change", {
                        current_slide: this.current_slide
                    }, this));
            ...
            _onMapChange(t) {
                this.current_slide != t.current_marker && (this.current_slide = t.current_marker,
                    this._storyslider.goTo(this.current_slide),
                    this.fire("change", {
                        current_slide: this.current_slide
                    }, this));
            ...
            _fireMouseEvent(t) {
                if(this._loaded) {
                    var e = t.type;
                    e = "mouseenter" === e ? "mouseover" : "mouseleave" === e ? "mouseout" : e,
                        this.hasEventListeners(e) && ("contextmenu" === e && DomEvent.preventDefault(t),
                            this.fire(e, {
                                latlng: "something",
                                layerPoint: "something else"
                            }));
